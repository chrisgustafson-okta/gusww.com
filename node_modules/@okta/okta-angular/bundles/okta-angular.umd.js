    ...
    ***************************************************************************** */
    ...
    function prioritizedGuardValue() {
        return operators.switchMap(obs => {
            ...
            }, INITIAL_VALUE), operators.filter(item => item !== INITIAL_VALUE), operators.map(item => isUrlTree(item) ? item : item === true), //
            operators.take(1));
        });
    }
    ...
    function noMatch$1(segmentGroup) {
        return new rxjs.Observable((obs) => obs.error(new NoMatch(segmentGroup)));
    }
    function absoluteRedirect(newTree) {
        return new rxjs.Observable((obs) => obs.error(new AbsoluteRedirect(newTree)));
    }
    function namedOutletsRedirect(redirectTo) {
        return new rxjs.Observable((obs) => obs.error(new Error(`Only absolute redirects can have named outlets. redirectTo: '${redirectTo}'`)));
    }
    function canLoadFails(route) {
        return new rxjs.Observable((obs) => obs.error(navigationCancelingError(`Cannot load children because the guard of the route "path: '${route.path}'" returned false`)));
    }
    /**
    ...
    class ApplyRedirects {
        ...
        matchSegmentAgainstRoute(ngModule, rawSegmentGroup, route, segments, outlet) {
            if (route.path === '**') {
                if (route.loadChildren) {
                    const loaded$ = route._loadedConfig ? rxjs.of(route._loadedConfig) :
        ...
        runCanLoadGuards(moduleInjector, route, segments) {
            ...
            return rxjs.of(canLoadObservables)
                .pipe(prioritizedGuardValue(), operators.tap((result) => {
                if (!isUrlTree(result))
                    return;
    ...
    function applyRedirects$1(moduleInjector, configLoader, urlSerializer, config) {
        return operators.switchMap(t => applyRedirects(moduleInjector, configLoader, urlSerializer, t.extractedUrl, config)
    ...
    function runCanDeactivateChecks(checks, futureRSS, currRSS, moduleInjector) {
        return rxjs.from(checks).pipe(operators.mergeMap(check => runCanDeactivate(check.component, check.route, currRSS, futureRSS, moduleInjector)), operators.first(result => {
            return result !== true;
        }, true));
    }
    ...
    function recognize$1(rootComponentType, config, serializer, paramsInheritanceStrategy, relativeLinkResolution) {
        return operators.mergeMap(t => recognize(rootComponentType, config, t.urlAfterRedirects, serializer(t.urlAfterRedirects), paramsInheritanceStrategy, relativeLinkResolution)
    ...
    function resolveData(paramsInheritanceStrategy, moduleInjector) {
        return operators.mergeMap(t => {
            ...
            return rxjs.from(canActivateChecks)
                .pipe(operators.concatMap(check => runResolve(check.route, targetSnapshot, paramsInheritanceStrategy, moduleInjector)), operators.tap(() => canActivateChecksResolved++), operators.takeLast(1), operators.mergeMap(_ => canActivateChecksResolved === canActivateChecks.length ? rxjs.of(t) : rxjs.EMPTY));
        });
    }
    function runResolve(futureARS, futureRSS, paramsInheritanceStrategy, moduleInjector) {
        const resolve = futureARS._resolve;
        return resolveNode(resolve, futureARS, futureRSS, moduleInjector)
            .pipe(operators.map((resolvedData) => {
    ...
    function resolveNode(resolve, futureARS, futureRSS, moduleInjector) {
        ...
        const data = {};
        return rxjs.from(keys).pipe(operators.mergeMap((key) => getResolver(resolve[key], futureARS, futureRSS, moduleInjector)
            .pipe(operators.tap((value) => {
            data[key] = value;
        }))), operators.takeLast(1), operators.mergeMap(() => {
     ...
     * @publicApi
     */
    const ROUTES = new core.InjectionToken('ROUTES');
    class RouterConfigLoader {
        ...
        load(parentInjector, route) {
            ...
            const loadRunner = moduleFactory$.pipe(operators.map((factory) => {
            ...
            route._loader$ = new rxjs.ConnectableObservable(loadRunner, () => new rxjs.Subject())
        ...
        loadModuleFactory(loadChildren) {
            if (typeof loadChildren === 'string') {
                ...
                return wrapIntoObservable(loadChildren()).pipe(operators.mergeMap((t) => {
    ...
    class Router {
        ...
        constructor(rootComponentType, urlSerializer, rootContexts, location, injector, loader, compiler, config) {
            ...
            const ngZone = injector.get(core.NgZone);
        ...
        setupNavigations(transitions) {
            ...
            // Extract URL
            operators.map(t => (Object.assign(Object.assign({}, t), { extractedUrl: this.urlHandlingStrategy.extract(t.rawUrl) }))), 
            ...
            operators.switchMap(t => {
                ...
                operators.tap(t => {
                    ...
                    if (processCurrentUrl) {
                        ...
                        if (processPreviousUrl) {
                            ...
                            return rxjs.of(Object.assign(Object.assign({}, t), { targetSnapshot, urlAfterRedirects: extractedUrl, extras: Object.assign(Object.assign({}, extras), { skipLocationChange: false, replaceUrl: false }) }));
                        }
                        else {
                ...
                }), operators.map(t => (Object.assign(Object.assign({}, t), { guards: getAllRouteGuards(t.targetSnapshot, t.currentSnapshot, this.rootContexts) }))), checkGuards(this.ngModule.injector, (evt) => this.triggerEvent(evt)), operators.tap(t => {
                ...
                switchTap(t => {
                    if (t.guards.canActivateChecks.length) {
                        return rxjs.of(t).pipe(operators.tap(t => {
                            ...
                            return rxjs.of(t).pipe(resolveData(this.paramsInheritanceStrategy, this.ngModule.injector), operators.tap({
                ...
                }), activateRoutes(this.rootContexts, this.routeReuseStrategy, (evt) => this.triggerEvent(evt)), operators.tap({
                    next() {
                        completed = true;
                    },
                    complete() {
    ...
    class RouterPreloader {
        ...
        preload() {
            const ngModule = this.injector.get(core.NgModuleRef);
        ...
        processRoutes(ngModule, routes) {
            ...
            return rxjs.from(res).pipe(operators.mergeAll(), operators.map((_) => void 0));
        }
        preloadConfig(ngModule, route) {
            return this.preloadingStrategy.preload(route, () => {
                const loaded$ = route._loadedConfig ? rxjs.of(route._loadedConfig) :
                    this.loader.load(ngModule.injector, route);
                return loaded$.pipe(operators.mergeMap((config) => {
     ...
     * @publicApi
     */
    const ROUTER_CONFIGURATION = new core.InjectionToken('ROUTER_CONFIGURATION');
    /**
     * @docsNotRequired
     */
    const ROUTER_FORROOT_GUARD = new core.InjectionToken('ROUTER_FORROOT_GUARD');
     ...
     * @publicApi
     */
    const ROUTER_INITIALIZER = new core.InjectionToken('Router Initializer');
     ...
     * @publicApi
     */
    const VERSION = new core.Version('11.2.10');
     ...
     *
     * See the License for the specific language governing permissions and limitations under the License.
     */e.default=a;},function(t,e,n){var r=n(21),o=n(24);r(e,"__esModule",{value:!0}),e.default=void 0;var i={makeIdxState:o(n(205)).default};
    /*!
     * Copyright (c) 2021-Present, Okta, Inc. and/or its affiliates. All rights reserved.
     * The Okta software accompanied by this notice is provided pursuant to the Apache License, Version 2.0 (the "License.")
     *
     ...
     *
     * See the License for the specific language governing permissions and limitations under the License.
     */e.default=i;},function(t,e,n){t.exports=n(373);},function(t,e,n){var r=n(374);t.exports=r;},function(t,e,n){var r=n(375),o=Array.prototype;t.exports=function(t){var e=t.find;return t===o||t instanceof Array&&e===o.find?r:e};},function(t,e,n){n(376);var r=n(36);t.exports=r("Array").find;},function(t,e,n){var r=n(9),o=n(62).find,i=n(166),a=!0;"find"in[]&&Array(1).find((function(){a=!1;})),r({target:"Array",proto:!0,forced:a},{find:function(t){return o(this,t,arguments.length>1?arguments[1]:void 0)}}),i("find");},function(t,e,n){var r=n(378),o=n(379),i=n(198),a=n(380);t.exports=function(t){return r(t)||o(t)||i(t)||a()},t.exports.default=t.exports,t.exports.__esModule=!0;},function(t,e,n){var r=n(193),o=n(202);t.exports=function(t){if(r(t))return o(t)},t.exports.default=t.exports,t.exports.__esModule=!0;},function(t,e,n){var r=n(123),o=n(124),i=n(200);t.exports=function(t){if(void 0!==r&&null!=o(t)||null!=t["@@iterator"])return i(t)},t.exports.default=t.exports,t.exports.__esModule=!0;},function(t,e){t.exports=function(){throw new TypeError("Invalid attempt to spread non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.")},t.exports.default=t.exports,t.exports.__esModule=!0;},function(t,e,n){var r=n(83),o=n(116),i=n(84),a=n(119),u=n(63),s=n(120),c=n(121),f=n(21),l=n(24);f(e,"__esModule",{value:!0}),e.parseIdxResponse=e.parseNonRemediations=void 0,n(64);var h,p=l(n(192)),d=l(n(122)),v=l(n(382)),y=l(n(389)),g=l(n(207)),m=l(n(125)),b=l(n(63)),w=l(n(84)),x=l(n(83)),k=l(n(203)),O=l(n(204)),S=l(n(126)),T=n(397),_=l(n(208)),E=n(410);function A(t,e){var n=r(t);if(o){var u=o(t);e&&(u=i(u).call(u,(function(e){return a(t,e).enumerable}))),n.push.apply(n,u);}return n}function R(t){for(var e=1;e<arguments.length;e++){var n,r=null!=arguments[e]?arguments[e]:{};if(e%2)u(n=A(Object(r),!0)).call(n,(function(e){(0, d.default)(t,e,r[e]);}));else if(s)c(t,s(r));else{var o;u(o=A(Object(r))).call(o,(function(e){f(t,e,a(r,e));}));}}return t}var j=(0, g.default)((0, m.default)(h=["remediation","context"]).call(h,(function(t){return [t,!0]}))),P=function(t){var e,n,r=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{},o={},i={};return (0, b.default)(e=(0, w.default)(n=(0, x.default)(t)).call(n,(function(t){return !j[t]}))).call(e,(function(e){var n;if("object"===(0, y.default)(t[e])&&!!t[e])if(t[e].rel)o[t[e].name]=(0, _.default)(t[e],r);else{var a=t[e],u=a.value,s=a.type,c=(0, v.default)(a,["value","type"]);i[e]=R({type:s},c),"object"===s?(i[e].value={},(0, b.default)(n=(0, k.default)(u)).call(n,(function(t){var n,a=(0, p.default)(t,2),u=a[0],s=a[1];s.rel?o[(0, O.default)(n="".concat(e,"-")).call(n,u.name||u)]=(0, _.default)(s,r):i[e].value[u]=s;}))):i[e].value=u;}else i[e]=t[e];})),{context:i,actions:o}};e.parseNonRemediations=P;var C=function t(e,n){var r;(0, b.default)(r=(0, x.default)(n)).call(r,(function(r){if("relatesTo"===r){var o=(0, S.default)(n[r])?n[r][0]:n[r];if("string"==typeof o){var i=(0, E.JSONPath)({path:o,json:e})[0];if(i)return void(n[r]=i)}}var a;(0, S.default)(n[r])&&(0, b.default)(a=n[r]).call(a,(function(n){return t(e,n)}));}));},I=function(t,e){var n=(0, T.generateRemediationFunctions)([t],e)[t.name];return R(R({},t),{},{action:n})};e.parseIdxResponse=function(t){var e,n=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{},r=(null===(e=t.remediation)||void 0===e?void 0:e.value)||[];(0, b.default)(r).call(r,(function(e){return C(t,e)}));var o=(0, m.default)(r).call(r,(function(t){return I(t,n)})),i=P(t,n),a=i.context,u=i.actions;return {remediations:o,context:a,actions:u}};},function(t,e,n){var r=n(383),o=n(206),i=n(386);t.exports=function(t,e){if(null==t)return {};var n,a,u=i(t,e);if(r){var s=r(t);for(a=0;a<s.length;a++)n=s[a],o(e).call(e,n)>=0||Object.prototype.propertyIsEnumerable.call(t,n)&&(u[n]=t[n]);}return u},t.exports.default=t.exports,t.exports.__esModule=!0;},function(t,e,n){t.exports=n(384);},function(t,e,n){var r=n(189);t.exports=r;},function(t,e,n){var r=n(140);t.exports=r;},function(t,e,n){var r=n(387),o=n(206);t.exports=function(t,e){if(null==t)return {};var n,i,a={},u=r(t);for(i=0;i<u.length;i++)n=u[i],o(e).call(e,n)>=0||(a[n]=t[n]);return a},t.exports.default=t.exports,t.exports.__esModule=!0;},function(t,e,n){t.exports=n(388);},function(t,e,n){var r=n(188);t.exports=r;},function(t,e,n){var r=n(123),o=n(390);function i(e){return "function"==typeof r&&"symbol"==typeof o?(t.exports=i=function(t){return typeof t},t.exports.default=t.exports,t.exports.__esModule=!0):(t.exports=i=function(t){return t&&"function"==typeof r&&t.constructor===r&&t!==r.prototype?"symbol":typeof t},t.exports.default=t.exports,t.exports.__esModule=!0),i(e)}t.exports=i,t.exports.default=t.exports,t.exports.__esModule=!0;},function(t,e,n){t.exports=n(391);},function(t,e,n){var r=n(392);t.exports=r;},function(t,e,n){n(197),n(46),n(58);var r=n(118);t.exports=r.f("iterator");},function(t,e,n){var r=n(394);t.exports=r;},function(t,e,n){n(105),n(395);var r=n(17);t.exports=r.Object.fromEntries;},function(t,e,n){var r=n(9),o=n(54),i=n(59);r({target:"Object",stat:!0},{fromEntries:function(t){var e={};return o(t,(function(t,n){i(e,t,n);}),{AS_ENTRIES:!0}),e}});},function(t,e,n){var r=n(194);t.exports=r;},function(t,e,n){var r=n(21),o=n(24);r(e,"__esModule",{value:!0}),e.generateRemediationFunctions=void 0,n(64);var i=o(n(207)),a=o(n(125)),u=o(n(208));e.generateRemediationFunctions=function(t){var e=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{};return (0, i.default)((0, a.default)(t).call(t,(function(t){return [t.name,(0, u.default)(t,e)]})))};},function(t,e,n){n(399);var r=n(402),o=n(404),i=n(406),a=n(124),u=n(126),s=n(408),c=n(21),f=n(24);c(e,"__esModule",{value:!0}),e.divideActionParamsByMutability=void 0;var l=f(n(126));function h(t,e){var n;if(void 0===i||null==a(t)){if(u(t)||(n=function(t,e){var n;if(!t)return;if("string"==typeof t)return p(t,e);var i=r(n=Object.prototype.toString.call(t)).call(n,8,-1);"Object"===i&&t.constructor&&(i=t.constructor.name);if("Map"===i||"Set"===i)return o(t);if("Arguments"===i||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(i))return p(t,e)}(t))||e&&t&&"number"==typeof t.length){n&&(t=n);var c=0,f=function(){};return {s:f,n:function(){return c>=t.length?{done:!0}:{done:!1,value:t[c++]}},e:function(t){throw t},f:f}}throw new TypeError("Invalid attempt to iterate non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.")}var l,h=!0,d=!1;return {s:function(){n=s(t);},n:function(){var t=n.next();return h=t.done,t},e:function(t){d=!0,l=t;},f:function(){try{h||null==n.return||n.return();}finally{if(d)throw l}}}}function p(t,e){(null==e||e>t.length)&&(e=t.length);for(var n=0,r=new Array(e);n<e;n++)r[n]=t[n];return r}
    /*!
     * Copyright (c) 2021-Present, Okta, Inc. and/or its affiliates. All rights reserved.
     * The Okta software accompanied by this notice is provided pursuant to the Apache License, Version 2.0 (the "License.")
     *
     ...
     *
     * See the License for the specific language governing permissions and limitations under the License.
     */n(64);var d=function(t){return !1!==t.mutable},v=function(t){var e={},n=[],r={};if(!t.value)return n.push(t),{defaultParamsForAction:e,neededParamsForAction:n,immutableParamsForAction:r};var o,i=h(t.value);try{for(i.s();!(o=i.n()).done;){var a,u,s=o.value;if(d(s))n.push(s),null!==(a=s.value)&&void 0!==a&&a&&(e[s.name]=s.value);else r[s.name]=null!==(u=s.value)&&void 0!==u?u:"";}}catch(t){i.e(t);}finally{i.f();}return {defaultParamsForAction:e,neededParamsForAction:n,immutableParamsForAction:r}};e.divideActionParamsByMutability=function(t){var e,n=[],r={},o={},i=h(t=(0, l.default)(t)?t:[t]);try{for(i.s();!(e=i.n()).done;){var a=e.value,u=v(a),s=u.defaultParamsForAction,c=u.neededParamsForAction,f=u.immutableParamsForAction;n.push(c),r[a.name]=s,o[a.name]=f;}}catch(t){i.e(t);}finally{i.f();}return {defaultParams:r,neededParams:n,immutableParams:o}};},function(t,e,n){var r=n(127),o=n(108),i=n(400);r||o(Object.prototype,"toString",i,{unsafe:!0});},function(t,e,n){var r=n(127),o=n(401);t.exports=r?{}.toString:function(){return "[object "+o(this)+"]"};},function(t,e,n){var r=n(127),o=n(107),i=n(81)("toStringTag"),a="Arguments"==o(function(){return arguments}());t.exports=r?o:function(t){var e,n,r;return void 0===t?"Undefined":null===t?"Null":"string"==typeof(n=function(t,e){try{return t[e]}catch(t){}}(e=Object(t),i))?n:a?o(e):"Object"==(r=o(e))&&"function"==typeof e.callee?"Arguments":r};},function(t,e,n){t.exports=n(403);},function(t,e,n){var r=n(199);t.exports=r;},function(t,e,n){t.exports=n(405);},function(t,e,n){var r=n(201);t.exports=r;},function(t,e,n){t.exports=n(407);},function(t,e,n){var r=n(195);t.exports=r;},function(t,e,n){t.exports=n(409);},function(t,e,n){n(58),n(46);var r=n(170);t.exports=r;},function(t,e,n){function r(t){return (r="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(t){return typeof t}:function(t){return t&&"function"==typeof Symbol&&t.constructor===Symbol&&t!==Symbol.prototype?"symbol":typeof t})(t)}function o(t){return (o=Object.setPrototypeOf?Object.getPrototypeOf:function(t){return t.__proto__||Object.getPrototypeOf(t)})(t)}function i(t,e){return (i=Object.setPrototypeOf||function(t,e){return t.__proto__=e,t})(t,e)}function a(){if("undefined"==typeof Reflect||!Reflect.construct)return !1;if(Reflect.construct.sham)return !1;if("function"==typeof Proxy)return !0;try{return Boolean.prototype.valueOf.call(Reflect.construct(Boolean,[],(function(){}))),!0}catch(t){return !1}}function u(t,e,n){return (u=a()?Reflect.construct:function(t,e,n){var r=[null];r.push.apply(r,e);var o=new(Function.bind.apply(t,r));return n&&i(o,n.prototype),o}).apply(null,arguments)}function s(t){var e="function"==typeof Map?new Map:void 0;return (s=function(t){if(null===t||(n=t,-1===Function.toString.call(n).indexOf("[native code]")))return t;var n;if("function"!=typeof t)throw new TypeError("Super expression must either be null or a function");if(void 0!==e){if(e.has(t))return e.get(t);e.set(t,r);}function r(){return u(t,arguments,o(this).constructor)}return r.prototype=Object.create(t.prototype,{constructor:{value:r,enumerable:!1,writable:!0,configurable:!0}}),i(r,t)})(t)}function c(t,e){return !e||"object"!=typeof e&&"function"!=typeof e?function(t){if(void 0===t)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return t}(t):e}function f(t){return function(t){if(Array.isArray(t))return h(t)}(t)||function(t){if("undefined"!=typeof Symbol&&null!=t[Symbol.iterator]||null!=t["@@iterator"])return Array.from(t)}(t)||l(t)||function(){throw new TypeError("Invalid attempt to spread non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.")}()}function l(t,e){if(t){if("string"==typeof t)return h(t,e);var n=Object.prototype.toString.call(t).slice(8,-1);return "Object"===n&&t.constructor&&(n=t.constructor.name),"Map"===n||"Set"===n?Array.from(t):"Arguments"===n||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)?h(t,e):void 0}}function h(t,e){(null==e||e>t.length)&&(e=t.length);for(var n=0,r=new Array(e);n<e;n++)r[n]=t[n];return r}n.r(e),n.d(e,"JSONPath",(function(){return g}));var p=Object.prototype.hasOwnProperty;function d(t,e){return (t=t.slice()).push(e),t}function v(t,e){return (e=e.slice()).unshift(t),e}var y=function(t){!function(t,e){if("function"!=typeof e&&null!==e)throw new TypeError("Super expression must either be null or a function");t.prototype=Object.create(e&&e.prototype,{constructor:{value:t,writable:!0,configurable:!0}}),e&&i(t,e);}(u,t);var e,n,r=(e=u,n=a(),function(){var t,r=o(e);if(n){var i=o(this).constructor;t=Reflect.construct(r,arguments,i);}else t=r.apply(this,arguments);return c(this,t)});function u(t){var e;return function(t,e){if(!(t instanceof e))throw new TypeError("Cannot call a class as a function")}(this,u),(e=r.call(this,'JSONPath should not be called with "new" (it prevents return of (unwrapped) scalar values)')).avoidNew=!0,e.value=t,e.name="NewError",e}return u}(s(Error));function g(t,e,n,o,i){if(!(this instanceof g))try{return new g(t,e,n,o,i)}catch(t){if(!t.avoidNew)throw t;return t.value}"string"==typeof t&&(i=o,o=n,n=e,e=t,t=null);var a=t&&"object"===r(t);if(t=t||{},this.json=t.json||n,this.path=t.path||e,this.resultType=t.resultType||"value",this.flatten=t.flatten||!1,this.wrap=!p.call(t,"wrap")||t.wrap,this.sandbox=t.sandbox||{},this.preventEval=t.preventEval||!1,this.parent=t.parent||null,this.parentProperty=t.parentProperty||null,this.callback=t.callback||o||null,this.otherTypeCallback=t.otherTypeCallback||i||function(){throw new TypeError("You must supply an otherTypeCallback callback option with the @other() operator.")},!1!==t.autostart){var u={path:a?t.path:e};a?"json"in t&&(u.json=t.json):u.json=n;var s=this.evaluate(u);if(!s||"object"!==r(s))throw new y(s);return s}}g.prototype.evaluate=function(t,e,n,o){var i=this,a=this.parent,u=this.parentProperty,s=this.flatten,c=this.wrap;if(this.currResultType=this.resultType,this.currPreventEval=this.preventEval,this.currSandbox=this.sandbox,n=n||this.callback,this.currOtherTypeCallback=o||this.otherTypeCallback,e=e||this.json,(t=t||this.path)&&"object"===r(t)&&!Array.isArray(t)){if(!t.path&&""!==t.path)throw new TypeError('You must supply a "path" property when providing an object argument to JSONPath.evaluate().');if(!p.call(t,"json"))throw new TypeError('You must supply a "json" property when providing an object argument to JSONPath.evaluate().');e=t.json,s=p.call(t,"flatten")?t.flatten:s,this.currResultType=p.call(t,"resultType")?t.resultType:this.currResultType,this.currSandbox=p.call(t,"sandbox")?t.sandbox:this.currSandbox,c=p.call(t,"wrap")?t.wrap:c,this.currPreventEval=p.call(t,"preventEval")?t.preventEval:this.currPreventEval,n=p.call(t,"callback")?t.callback:n,this.currOtherTypeCallback=p.call(t,"otherTypeCallback")?t.otherTypeCallback:this.currOtherTypeCallback,a=p.call(t,"parent")?t.parent:a,u=p.call(t,"parentProperty")?t.parentProperty:u,t=t.path;}if(a=a||null,u=u||null,Array.isArray(t)&&(t=g.toPathString(t)),(t||""===t)&&e){var f=g.toPathArray(t);"$"===f[0]&&f.length>1&&f.shift(),this._hasParentSelector=null;var l=this._trace(f,e,["$"],a,u,n).filter((function(t){return t&&!t.isParentSelector}));return l.length?c||1!==l.length||l[0].hasArrExpr?l.reduce((function(t,e){var n=i._getPreferredOutput(e);return s&&Array.isArray(n)?t=t.concat(n):t.push(n),t}),[]):this._getPreferredOutput(l[0]):c?[]:void 0}},g.prototype._getPreferredOutput=function(t){var e=this.currResultType;switch(e){case"all":var n=Array.isArray(t.path)?t.path:g.toPathArray(t.path);return t.pointer=g.toPointer(n),t.path="string"==typeof t.path?t.path:g.toPathString(t.path),t;case"value":case"parent":case"parentProperty":return t[e];case"path":return g.toPathString(t[e]);case"pointer":return g.toPointer(t.path);default:throw new TypeError("Unknown result type")}},g.prototype._handleCallback=function(t,e,n){if(e){var r=this._getPreferredOutput(t);t.path="string"==typeof t.path?t.path:g.toPathString(t.path),e(r,n,t);}},g.prototype._trace=function(t,e,n,o,i,a,u,s){var c,f=this;if(!t.length)return c={path:n,value:e,parent:o,parentProperty:i,hasArrExpr:u},this._handleCallback(c,a,"value"),c;var h=t[0],y=t.slice(1),g=[];function m(t){Array.isArray(t)?t.forEach((function(t){g.push(t);})):g.push(t);}if(("string"!=typeof h||s)&&e&&p.call(e,h))m(this._trace(y,e[h],d(n,h),e,h,a,u));else if("*"===h)this._walk(h,y,e,n,o,i,a,(function(t,e,n,r,o,i,a,u){m(f._trace(v(t,n),r,o,i,a,u,!0,!0));}));else if(".."===h)m(this._trace(y,e,n,o,i,a,u)),this._walk(h,y,e,n,o,i,a,(function(t,e,n,o,i,a,u,s){"object"===r(o[t])&&m(f._trace(v(e,n),o[t],d(i,t),o,t,s,!0));}));else{if("^"===h)return this._hasParentSelector=!0,{path:n.slice(0,-1),expr:y,isParentSelector:!0};if("~"===h)return c={path:d(n,h),value:i,parent:o,parentProperty:null},this._handleCallback(c,a,"property"),c;if("$"===h)m(this._trace(y,e,n,null,null,a,u));else if(/^(\x2D?[0-9]*):(\x2D?[0-9]*):?([0-9]*)$/.test(h))m(this._slice(h,y,e,n,o,i,a));else if(0===h.indexOf("?(")){if(this.currPreventEval)throw new Error("Eval [?(expr)] prevented in JSONPath expression.");this._walk(h,y,e,n,o,i,a,(function(t,e,n,r,o,i,a,u){f._eval(e.replace(/^\?\(((?:[\0-\t\x0B\f\x0E-\u2027\u202A-\uD7FF\uE000-\uFFFF]|[\uD800-\uDBFF][\uDC00-\uDFFF]|[\uD800-\uDBFF](?![\uDC00-\uDFFF])|(?:[^\uD800-\uDBFF]|^)[\uDC00-\uDFFF])*?)\)$/,"$1"),r[t],t,o,i,a)&&m(f._trace(v(t,n),r,o,i,a,u,!0));}));}else if("("===h[0]){if(this.currPreventEval)throw new Error("Eval [(expr)] prevented in JSONPath expression.");m(this._trace(v(this._eval(h,e,n[n.length-1],n.slice(0,-1),o,i),y),e,n,o,i,a,u));}else if("@"===h[0]){var b=!1,w=h.slice(1,-2);switch(w){case"scalar":e&&["object","function"].includes(r(e))||(b=!0);break;case"boolean":case"string":case"undefined":case"function":r(e)===w&&(b=!0);break;case"integer":!Number.isFinite(e)||e%1||(b=!0);break;case"number":Number.isFinite(e)&&(b=!0);break;case"nonFinite":"number"!=typeof e||Number.isFinite(e)||(b=!0);break;case"object":e&&r(e)===w&&(b=!0);break;case"array":Array.isArray(e)&&(b=!0);break;case"other":b=this.currOtherTypeCallback(e,n,o,i);break;case"null":null===e&&(b=!0);break;default:throw new TypeError("Unknown value type "+w)}if(b)return c={path:n,value:e,parent:o,parentProperty:i},this._handleCallback(c,a,"value"),c}else if("`"===h[0]&&e&&p.call(e,h.slice(1))){var x=h.slice(1);m(this._trace(y,e[x],d(n,x),e,x,a,u,!0));}else if(h.includes(",")){var k,O=function(t,e){var n="undefined"!=typeof Symbol&&t[Symbol.iterator]||t["@@iterator"];if(!n){if(Array.isArray(t)||(n=l(t))||e&&t&&"number"==typeof t.length){n&&(t=n);var r=0,o=function(){};return {s:o,n:function(){return r>=t.length?{done:!0}:{done:!1,value:t[r++]}},e:function(t){throw t},f:o}}throw new TypeError("Invalid attempt to iterate non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.")}var i,a=!0,u=!1;return {s:function(){n=n.call(t);},n:function(){var t=n.next();return a=t.done,t},e:function(t){u=!0,i=t;},f:function(){try{a||null==n.return||n.return();}finally{if(u)throw i}}}}(h.split(","));try{for(O.s();!(k=O.n()).done;){var S=k.value;m(this._trace(v(S,y),e,n,o,i,a,!0));}}catch(t){O.e(t);}finally{O.f();}}else!s&&e&&p.call(e,h)&&m(this._trace(y,e[h],d(n,h),e,h,a,u,!0));}if(this._hasParentSelector)for(var T=0;T<g.length;T++){var _=g[T];if(_&&_.isParentSelector){var E=this._trace(_.expr,e,_.path,o,i,a,u);if(Array.isArray(E)){g[T]=E[0];for(var A=E.length,R=1;R<A;R++)T++,g.splice(T,0,E[R]);}else g[T]=E;}}return g},g.prototype._walk=function(t,e,n,o,i,a,u,s){if(Array.isArray(n))for(var c=n.length,f=0;f<c;f++)s(f,t,e,n,o,i,a,u);else n&&"object"===r(n)&&Object.keys(n).forEach((function(r){s(r,t,e,n,o,i,a,u);}));},g.prototype._slice=function(t,e,n,r,o,i,a){if(Array.isArray(n)){var u=n.length,s=t.split(":"),c=s[2]&&Number.parseInt(s[2])||1,f=s[0]&&Number.parseInt(s[0])||0,l=s[1]&&Number.parseInt(s[1])||u;f=f<0?Math.max(0,f+u):Math.min(u,f),l=l<0?Math.max(0,l+u):Math.min(u,l);for(var h=[],p=f;p<l;p+=c){this._trace(v(p,e),n,r,o,i,a,!0).forEach((function(t){h.push(t);}));}return h}},g.prototype._eval=function(t,e,n,r,o,i){t.includes("@parentProperty")&&(this.currSandbox._$_parentProperty=i,t=t.replace(/@parentProperty/g,"_$_parentProperty")),t.includes("@parent")&&(this.currSandbox._$_parent=o,t=t.replace(/@parent/g,"_$_parent")),t.includes("@property")&&(this.currSandbox._$_property=n,t=t.replace(/@property/g,"_$_property")),t.includes("@path")&&(this.currSandbox._$_path=g.toPathString(r.concat([n])),t=t.replace(/@path/g,"_$_path")),t.includes("@root")&&(this.currSandbox._$_root=this.json,t=t.replace(/@root/g,"_$_root")),/@([\t-\r \)\.\[\xA0\u1680\u2000-\u200A\u2028\u2029\u202F\u205F\u3000\uFEFF])/.test(t)&&(this.currSandbox._$_v=e,t=t.replace(/@([\t-\r \)\.\[\xA0\u1680\u2000-\u200A\u2028\u2029\u202F\u205F\u3000\uFEFF])/g,"_$_v$1"));try{return this.vm.runInNewContext(t,this.currSandbox)}catch(e){throw console.log(e),new Error("jsonPath: "+e.message+": "+t)}},g.cache={},g.toPathString=function(t){for(var e=t,n=e.length,r="$",o=1;o<n;o++)/^(~|\^|@(?:[\0-\t\x0B\f\x0E-\u2027\u202A-\uD7FF\uE000-\uFFFF]|[\uD800-\uDBFF][\uDC00-\uDFFF]|[\uD800-\uDBFF](?![\uDC00-\uDFFF])|(?:[^\uD800-\uDBFF]|^)[\uDC00-\uDFFF])*?\(\))$/.test(e[o])||(r+=/^[\*0-9]+$/.test(e[o])?"["+e[o]+"]":"['"+e[o]+"']");return r},g.toPointer=function(t){for(var e=t,n=e.length,r="",o=1;o<n;o++)/^(~|\^|@(?:[\0-\t\x0B\f\x0E-\u2027\u202A-\uD7FF\uE000-\uFFFF]|[\uD800-\uDBFF][\uDC00-\uDFFF]|[\uD800-\uDBFF](?![\uDC00-\uDFFF])|(?:[^\uD800-\uDBFF]|^)[\uDC00-\uDFFF])*?\(\))$/.test(e[o])||(r+="/"+e[o].toString().replace(/~/g,"~0").replace(/\//g,"~1"));return r},g.toPathArray=function(t){var e=g.cache;if(e[t])return e[t].concat();var n=[],r=t.replace(/@(?:null|boolean|number|string|integer|undefined|nonFinite|scalar|array|object|function|other)\(\)/g,";$&;").replace(/['\[](\??\((?:[\0-\t\x0B\f\x0E-\u2027\u202A-\uD7FF\uE000-\uFFFF]|[\uD800-\uDBFF][\uDC00-\uDFFF]|[\uD800-\uDBFF](?![\uDC00-\uDFFF])|(?:[^\uD800-\uDBFF]|^)[\uDC00-\uDFFF])*?\))['\]]/g,(function(t,e){return "[#"+(n.push(e)-1)+"]"})).replace(/\[["']((?:(?!['\]])[\s\S])*)["']\]/g,(function(t,e){return "['"+e.replace(/\./g,"%@%").replace(/~/g,"%%@@%%")+"']"})).replace(/~/g,";~;").replace(/["']?\.["']?(?!(?:(?!\[)[\s\S])*\])|\[["']?/g,";").replace(/%@%/g,".").replace(/%%@@%%/g,"~").replace(/(?:;)?(\^+)(?:;)?/g,(function(t,e){return ";"+e.split("").join(";")+";"})).replace(/;;;|;;/g,";..;").replace(/;$|'?\]|'$/g,"").split(";").map((function(t){var e=t.match(/#([0-9]+)/);return e&&e[1]?n[e[1]]:t}));return e[t]=r,e[t].concat()};g.prototype.vm={runInNewContext:function(t,e){var n=Object.keys(e),r=[];!function(t,e,n){for(var r=t.length,o=0;o<r;o++){n(t[o])&&e.push(t.splice(o--,1)[0]);}}(n,r,(function(t){return "function"==typeof e[t]}));var o=n.map((function(t,n){return e[t]})),i=r.reduce((function(t,n){var r=e[n].toString();return /function/.test(r)||(r="function "+r),"var "+n+"="+r+";"+t}),"");/(["'])use strict\1/.test(t=i+t)||n.includes("arguments")||(t="var arguments = undefined;"+t);var a=(t=t.replace(/;[\t-\r \xA0\u1680\u2000-\u200A\u2028\u2029\u202F\u205F\u3000\uFEFF]*$/,"")).lastIndexOf(";"),s=a>-1?t.slice(0,a+1)+" return "+t.slice(a+1):" return "+t;return u(Function,f(n).concat([s])).apply(void 0,f(o))}};},function(t,e,n){var r=n(3);t.exports=function(t,e){for(;!Object.prototype.hasOwnProperty.call(t,e)&&null!==(t=r(t)););return t},t.exports.default=t.exports,t.exports.__esModule=!0;},function(t,e){var n,r,o=t.exports={};function i(){throw new Error("setTimeout has not been defined")}function a(){throw new Error("clearTimeout has not been defined")}function u(t){if(n===setTimeout)return setTimeout(t,0);if((n===i||!n)&&setTimeout)return n=setTimeout,setTimeout(t,0);try{return n(t,0)}catch(e){try{return n.call(null,t,0)}catch(e){return n.call(this,t,0)}}}!function(){try{n="function"==typeof setTimeout?setTimeout:i;}catch(t){n=i;}try{r="function"==typeof clearTimeout?clearTimeout:a;}catch(t){r=a;}}();var s,c=[],f=!1,l=-1;function h(){f&&s&&(f=!1,s.length?c=s.concat(c):l=-1,c.length&&p());}function p(){if(!f){var t=u(h);f=!0;for(var e=c.length;e;){for(s=c,c=[];++l<e;)s&&s[l].run();l=-1,e=c.length;}s=null,f=!1,function(t){if(r===clearTimeout)return clearTimeout(t);if((r===a||!r)&&clearTimeout)return r=clearTimeout,clearTimeout(t);try{r(t);}catch(e){try{return r.call(null,t)}catch(e){return r.call(this,t)}}}(t);}}function d(t,e){this.fun=t,this.array=e;}function v(){}o.nextTick=function(t){var e=new Array(arguments.length-1);if(arguments.length>1)for(var n=1;n<arguments.length;n++)e[n-1]=arguments[n];c.push(new d(t,e)),1!==c.length||f||u(p);},d.prototype.run=function(){this.fun.apply(null,this.array);},o.title="browser",o.browser=!0,o.env={},o.argv=[],o.version="",o.versions={},o.on=v,o.addListener=v,o.once=v,o.off=v,o.removeListener=v,o.removeAllListeners=v,o.emit=v,o.prependListener=v,o.prependOnceListener=v,o.listeners=function(t){return []},o.binding=function(t){throw new Error("process.binding is not supported")},o.cwd=function(){return "/"},o.chdir=function(t){throw new Error("process.chdir is not supported")},o.umask=function(){return 0};},function(t,e){function n(){}n.prototype={on:function(t,e,n){var r=this.e||(this.e={});return (r[t]||(r[t]=[])).push({fn:e,ctx:n}),this},once:function(t,e,n){var r=this;function o(){r.off(t,o),e.apply(n,arguments);}return o._=e,this.on(t,o,n)},emit:function(t){for(var e=[].slice.call(arguments,1),n=((this.e||(this.e={}))[t]||[]).slice(),r=0,o=n.length;r<o;r++)n[r].fn.apply(n[r].ctx,e);return this},off:function(t,e){var n=this.e||(this.e={}),r=n[t],o=[];if(r&&e)for(var i=0,a=r.length;i<a;i++)r[i].fn!==e&&r[i].fn._!==e&&o.push(r[i]);return o.length?n[t]=o:delete n[t],this}},t.exports=n;},function(t,e,n){n.r(e),n.d(e,"OktaAuth",(function(){return co})),n.d(e,"STATE_TOKEN_KEY_NAME",(function(){return l})),n.d(e,"DEFAULT_POLLING_DELAY",(function(){return h})),n.d(e,"DEFAULT_MAX_CLOCK_SKEW",(function(){return p})),n.d(e,"DEFAULT_CACHE_DURATION",(function(){return d})),n.d(e,"REDIRECT_OAUTH_PARAMS_NAME",(function(){return v})),n.d(e,"REDIRECT_STATE_COOKIE_NAME",(function(){return y})),n.d(e,"REDIRECT_NONCE_COOKIE_NAME",(function(){return g})),n.d(e,"TOKEN_STORAGE_NAME",(function(){return m})),n.d(e,"CACHE_STORAGE_NAME",(function(){return b})),n.d(e,"PKCE_STORAGE_NAME",(function(){return w})),n.d(e,"TRANSACTION_STORAGE_NAME",(function(){return x})),n.d(e,"IDX_RESPONSE_STORAGE_NAME",(function(){return k})),n.d(e,"ACCESS_TOKEN_STORAGE_KEY",(function(){return O})),n.d(e,"ID_TOKEN_STORAGE_KEY",(function(){return S})),n.d(e,"REFRESH_TOKEN_STORAGE_KEY",(function(){return T})),n.d(e,"REFERRER_PATH_STORAGE_KEY",(function(){return _})),n.d(e,"MIN_VERIFIER_LENGTH",(function(){return E})),n.d(e,"MAX_VERIFIER_LENGTH",(function(){return A})),n.d(e,"DEFAULT_CODE_CHALLENGE_METHOD",(function(){return R})),n.d(e,"IDX_API_VERSION",(function(){return j})),n.d(e,"isOAuthTransactionMeta",(function(){return Jt})),n.d(e,"isPKCETransactionMeta",(function(){return $t})),n.d(e,"isIdxTransactionMeta",(function(){return Wt})),n.d(e,"isCustomAuthTransactionMeta",(function(){return Xt})),n.d(e,"isTransactionMeta",(function(){return Zt})),n.d(e,"IdxStatus",(function(){return Kt})),n.d(e,"IdxFeature",(function(){return Vt})),n.d(e,"isToken",(function(){return Qt})),n.d(e,"isAccessToken",(function(){return te})),n.d(e,"isIDToken",(function(){return ee})),n.d(e,"isRefreshToken",(function(){return ne})),n.d(e,"transactionStatus",(function(){return z})),n.d(e,"resumeTransaction",(function(){return Y})),n.d(e,"transactionExists",(function(){return J})),n.d(e,"postToTransaction",(function(){return $})),n.d(e,"introspect",(function(){return G})),n.d(e,"AuthTransaction",(function(){return q})),n.d(e,"getPollFn",(function(){return H})),n.d(e,"TransactionState",(function(){return W})),n.d(e,"addStateToken",(function(){return N})),n.d(e,"getStateToken",(function(){return D})),n.d(e,"isAuthApiError",(function(){return it.e})),n.d(e,"AuthApiError",(function(){return it.a})),n.d(e,"AuthPollStopError",(function(){return it.b})),n.d(e,"AuthSdkError",(function(){return it.c})),n.d(e,"OAuthError",(function(){return it.d})),n.d(e,"convertTokenParamsToOAuthParams",(function(){return at})),n.d(e,"buildAuthorizeParams",(function(){return ut})),n.d(e,"postToTokenEndpoint",(function(){return ft})),n.d(e,"postRefreshToken",(function(){return lt})),n.d(e,"getWellKnown",(function(){return ht})),n.d(e,"getKey",(function(){return pt})),n.d(e,"addListener",(function(){return vt})),n.d(e,"removeListener",(function(){return yt})),n.d(e,"loadFrame",(function(){return gt})),n.d(e,"loadPopup",(function(){return mt})),n.d(e,"addPostMessageListener",(function(){return bt})),n.d(e,"getDefaultTokenParams",(function(){return _t})),n.d(e,"isInteractionRequiredError",(function(){return Et})),n.d(e,"isAuthorizationCodeError",(function(){return At})),n.d(e,"hasTokensInHash",(function(){return Rt})),n.d(e,"hasAuthorizationCode",(function(){return jt})),n.d(e,"hasInteractionCode",(function(){return Pt})),n.d(e,"hasErrorInUrl",(function(){return Ct})),n.d(e,"isRedirectUri",(function(){return It})),n.d(e,"isCodeFlow",(function(){return Mt})),n.d(e,"getHashOrSearch",(function(){return Ut})),n.d(e,"isLoginRedirect",(function(){return Lt})),n.d(e,"isInteractionRequired",(function(){return Ft})),n.d(e,"generateState",(function(){return wt})),n.d(e,"generateNonce",(function(){return xt})),n.d(e,"getOAuthBaseUrl",(function(){return Ot})),n.d(e,"getOAuthDomain",(function(){return St})),n.d(e,"getOAuthUrls",(function(){return Tt})),n.d(e,"pkce",(function(){return Q})),n.d(e,"prepareTokenParams",(function(){return Nt})),n.d(e,"isSameRefreshToken",(function(){return Dt})),n.d(e,"isRefreshTokenError",(function(){return Bt})),n.d(e,"urlParamsToObject",(function(){return Ht})),n.d(e,"validateClaims",(function(){return qt})),n.d(e,"validateToken",(function(){return re})),n.d(e,"decodeToken",(function(){return oe})),n.d(e,"revokeToken",(function(){return ie})),n.d(e,"renewToken",(function(){return ge})),n.d(e,"renewTokensWithRefresh",(function(){return pe})),n.d(e,"renewTokens",(function(){return be})),n.d(e,"verifyToken",(function(){return se})),n.d(e,"getUserInfo",(function(){return xe})),n.d(e,"handleOAuthResponse",(function(){return ce})),n.d(e,"exchangeCodeForTokens",(function(){return ae})),n.d(e,"getToken",(function(){return fe})),n.d(e,"getWithoutPrompt",(function(){return le})),n.d(e,"getWithPopup",(function(){return ke})),n.d(e,"getWithRedirect",(function(){return Oe})),n.d(e,"parseFromUrl",(function(){return Se})),n.d(e,"EVENT_EXPIRED",(function(){return Me})),n.d(e,"EVENT_RENEWED",(function(){return Ue})),n.d(e,"EVENT_ADDED",(function(){return Le})),n.d(e,"EVENT_REMOVED",(function(){return Fe})),n.d(e,"EVENT_ERROR",(function(){return Ne})),n.d(e,"TokenManager",(function(){return De})),n.d(e,"INITIAL_AUTH_STATE",(function(){return Ve})),n.d(e,"AuthStateManager",(function(){return Ye})),n.d(e,"getNativeConsole",(function(){return C.k})),n.d(e,"getConsole",(function(){return C.i})),n.d(e,"warn",(function(){return C.y})),n.d(e,"deprecate",(function(){return C.d})),n.d(e,"deprecateWrap",(function(){return C.e})),n.d(e,"isoToUTCString",(function(){return C.r})),n.d(e,"genRandomString",(function(){return C.h})),n.d(e,"delay",(function(){return C.c})),n.d(e,"bind",(function(){return C.a})),n.d(e,"extend",(function(){return C.f})),n.d(e,"removeNils",(function(){return C.t})),n.d(e,"clone",(function(){return C.b})),n.d(e,"omit",(function(){return C.s})),n.d(e,"find",(function(){return C.g})),n.d(e,"getLink",(function(){return C.j})),n.d(e,"isString",(function(){return C.q})),n.d(e,"isObject",(function(){return C.o})),n.d(e,"isNumber",(function(){return C.n})),n.d(e,"isFunction",(function(){return C.m})),n.d(e,"isPromise",(function(){return C.p})),n.d(e,"isAbsoluteUrl",(function(){return C.l})),n.d(e,"toAbsoluteUrl",(function(){return C.v})),n.d(e,"toRelativeUrl",(function(){return C.x})),n.d(e,"toQueryString",(function(){return C.w})),n.d(e,"removeTrailingSlash",(function(){return C.u})),n.d(e,"crypto",(function(){return X}));var r={};n.r(r),n.d(r,"STATE_TOKEN_KEY_NAME",(function(){return l})),n.d(r,"DEFAULT_POLLING_DELAY",(function(){return h})),n.d(r,"DEFAULT_MAX_CLOCK_SKEW",(function(){return p})),n.d(r,"DEFAULT_CACHE_DURATION",(function(){return d})),n.d(r,"REDIRECT_OAUTH_PARAMS_NAME",(function(){return v})),n.d(r,"REDIRECT_STATE_COOKIE_NAME",(function(){return y})),n.d(r,"REDIRECT_NONCE_COOKIE_NAME",(function(){return g})),n.d(r,"TOKEN_STORAGE_NAME",(function(){return m})),n.d(r,"CACHE_STORAGE_NAME",(function(){return b})),n.d(r,"PKCE_STORAGE_NAME",(function(){return w})),n.d(r,"TRANSACTION_STORAGE_NAME",(function(){return x})),n.d(r,"IDX_RESPONSE_STORAGE_NAME",(function(){return k})),n.d(r,"ACCESS_TOKEN_STORAGE_KEY",(function(){return O})),n.d(r,"ID_TOKEN_STORAGE_KEY",(function(){return S})),n.d(r,"REFRESH_TOKEN_STORAGE_KEY",(function(){return T})),n.d(r,"REFERRER_PATH_STORAGE_KEY",(function(){return _})),n.d(r,"MIN_VERIFIER_LENGTH",(function(){return E})),n.d(r,"MAX_VERIFIER_LENGTH",(function(){return A})),n.d(r,"DEFAULT_CODE_CHALLENGE_METHOD",(function(){return R})),n.d(r,"IDX_API_VERSION",(function(){return j}));var o={};n.r(o),n.d(o,"Remediator",(function(){return Ln})),n.d(o,"EnrollAuthenticator",(function(){return Yn})),n.d(o,"ChallengeAuthenticator",(function(){return Jn})),n.d(o,"ResetAuthenticator",(function(){return Wn})),n.d(o,"EnrollProfile",(function(){return tr})),n.d(o,"Identify",(function(){return or})),n.d(o,"ReEnrollAuthenticator",(function(){return ar})),n.d(o,"RedirectIdp",(function(){return sr})),n.d(o,"SelectAuthenticatorAuthenticate",(function(){return vr})),n.d(o,"SelectAuthenticatorEnroll",(function(){return gr})),n.d(o,"SelectEnrollProfile",(function(){return br})),n.d(o,"AuthenticatorVerificationData",(function(){return Or})),n.d(o,"AuthenticatorEnrollmentData",(function(){return Tr})),n.d(o,"Skip",(function(){return Er}));var i=n(4),a=n.n(i),u=n(5),s=n.n(u),c=n(1),f=n.n(c),l="oktaStateToken",h=500,p=300,d=86400,v="okta-oauth-redirect-params",y="okta-oauth-state",g="okta-oauth-nonce",m="okta-token-storage",b="okta-cache-storage",w="okta-pkce-storage",x="okta-transaction-storage",k="okta-idx-response-storage",O="accessToken",S="idToken",T="refreshToken",_="referrerPath",E=43,A=128,R="S256",j="1.0.0";function P(t,e,n){t.options.headers=t.options.headers||{},t.options.headers[e]=n;}var C=n(0),I=n(65);function M(t,e){var n=(e=e||{}).url,r=e.method,o=e.args,i=e.saveAuthnState,a=e.accessToken,u=!0===e.withCredentials,s=t.options.storageUtil.storage,c=t.storageManager.getHttpCache(t.options.cookies);if(e.cacheResponse){var f=c.getStorage()[n];if(f&&Date.now()/1e3<f.expiresAt)return Promise.resolve(f.response)}var h=t._oktaUserAgent.getHttpHeader(),p=Object.assign({Accept:"application/json","Content-Type":"application/json"},h);Object.assign(p,t.options.headers,e.headers),p=Object(C.t)(p),a&&Object(C.q)(a)&&(p.Authorization="Bearer "+a);var v,y,g={headers:p,data:o||void 0,withCredentials:u};return t.options.httpRequestClient(r,n,g).then((function(r){return (y=r.responseText)&&Object(C.q)(y)&&(y=JSON.parse(y)),i&&(y.stateToken||s.delete(l)),y&&y.stateToken&&y.expiresAt&&s.set(l,y.stateToken,y.expiresAt,t.options.cookies),y&&e.cacheResponse&&c.updateStorage(n,{expiresAt:Math.floor(Date.now()/1e3)+d,response:y}),y})).catch((function(e){var n=e.responseText||{};if(Object(C.q)(n))try{n=JSON.parse(n);}catch(t){n={errorSummary:"Unknown error"};}throw e.status>=500&&(n.errorSummary="Unknown error"),t.options.transformErrorXHR&&(e=t.options.transformErrorXHR(Object(C.b)(e))),"E0000011"===(v=new I.a(n,e)).errorCode&&s.delete(l),v}))}function U(t,e,n){var r={url:e=Object(C.l)(e)?e:t.getIssuerOrigin()+e,method:"GET"};return Object.assign(r,n),M(t,r)}function L(t,e,n,r){var o={url:e=Object(C.l)(e)?e:t.getIssuerOrigin()+e,method:"POST",args:n,saveAuthnState:!0};return Object.assign(o,r),M(t,o)}var F=n(8);function N(t,e){var n={};return Object.assign(n,e),!n.stateToken&&t.stateToken&&(n.stateToken=t.stateToken),n}function D(t){return N(t)}var B=n(66);function H(t,e,n){return function(r){var o,i,a,u;Object(C.n)(r)?o=r:Object(C.o)(r)&&(o=(r=r).delay,i=r.rememberDevice,a=r.autoPush,u=r.transactionCallBack),o||0===o||(o=h);var s=Object(C.j)(e,"next","poll");n.isPolling=!0;var c=0;return function r(){return n.isPolling?function(){var n={};if("function"==typeof a)try{n.autoPush=!!a();}catch(t){return Promise.reject(new F.a("AutoPush resulted in an error."))}else null!=a&&(n.autoPush=!!a);if("function"==typeof i)try{n.rememberDevice=!!i();}catch(t){return Promise.reject(new F.a("RememberDevice resulted in an error."))}else null!=i&&(n.rememberDevice=!!i);var r=s.href+Object(C.w)(n);return L(t,r,D(e),{saveAuthnState:!1,withCredentials:!0})}().then((function(e){if(c=0,e.factorResult&&"WAITING"===e.factorResult){if(!n.isPolling)throw new B.a;return "function"==typeof u&&u(e),Object(C.c)(o).then(r)}return n.isPolling=!1,new q(t,e)})).catch((function(t){if(t.xhr&&(0===t.xhr.status||429===t.xhr.status)&&c<=4){var e=1e3*Math.pow(2,c);return c++,Object(C.c)(e).then(r)}throw t})):Promise.reject(new B.a)}().catch((function(t){throw n.isPolling=!1,t}))}}var q=function t(e){var n=arguments.length>1&&void 0!==arguments[1]?arguments[1]:null;if(a()(this,t),n){if(this.data=n,this.data.interactionHandle)return void(this.status=n.status);Object.assign(this,V(e,n,n,{})),delete this.stateToken,"RECOVERY_CHALLENGE"!==n.status||n._links||(this.cancel=function(){return Promise.resolve(new t(e))});}};function K(t,e,n,r,o){if(Array.isArray(r))return function(i,a){if(!i)throw new F.a("Must provide a link name");var u=Object(C.g)(r,{name:i});if(!u)throw new F.a("No link found for that name");return K(t,e,n,u,o)(a)};if(r.hints&&r.hints.allow&&1===r.hints.allow.length)switch(r.hints.allow[0]){case"GET":return function(){return U(t,r.href,{withCredentials:!0})};case"POST":return function(i){o&&o.isPolling&&(o.isPolling=!1);var a=N(e,i);"MFA_ENROLL"!==e.status&&"FACTOR_ENROLL"!==e.status||Object.assign(a,{factorType:n.factorType,provider:n.provider});var u={},s=a.autoPush;if(void 0!==s){if("function"==typeof s)try{u.autoPush=!!s();}catch(t){return Promise.reject(new F.a("AutoPush resulted in an error."))}else null!==s&&(u.autoPush=!!s);a=Object(C.s)(a,"autoPush");}var c=a.rememberDevice;if(void 0!==c){if("function"==typeof c)try{u.rememberDevice=!!c();}catch(t){return Promise.reject(new F.a("RememberDevice resulted in an error."))}else null!==c&&(u.rememberDevice=!!c);a=Object(C.s)(a,"rememberDevice");}else a.profile&&void 0!==a.profile.updatePhone&&(a.profile.updatePhone&&(u.updatePhone=!0),a.profile=Object(C.s)(a.profile,"updatePhone"));var f=r.href+Object(C.w)(u);return $(t,f,a,{withCredentials:!0})}}}function V(t,e,n,r){if(n=n||e,n=Object(C.b)(n),Array.isArray(n)){for(var o=[],i=0,a=n.length;i<a;i++)o.push(V(t,e,n[i],r));return o}var u=n._embedded||{};for(var s in u)Object.prototype.hasOwnProperty.call(u,s)&&(Object(C.o)(u[s])||Array.isArray(u[s]))&&(u[s]=V(t,e,u[s],r));var c=function(t,e,n,r){var o={};for(var i in n._links)if(Object.prototype.hasOwnProperty.call(n._links,i)){var a=n._links[i];if("next"===i&&(i=a.name),a.type)o[i]=a;else switch(i){case"poll":o.poll=H(t,e,r);break;default:var u=K(t,e,n,a,r);u&&(o[i]=u);}}return o}(t,e,n,r);return Object.assign(u,c),n=Object(C.s)(n,"_embedded","_links"),Object.assign(n,u),n}function z(t,e){return e=N(t,e),L(t,t.getIssuerOrigin()+"/api/v1/authn",e,{withCredentials:!0})}function Y(t,e){if(!e||!e.stateToken){var n=t.tx.exists._get(l);if(!n)return Promise.reject(new F.a("No transaction to resume"));e={stateToken:n};}return t.tx.status(e).then((function(e){return new q(t,e)}))}function G(t,e){if(!e||!e.stateToken){var n=t.tx.exists._get(l);if(!n)return Promise.reject(new F.a("No transaction to evaluate"));e={stateToken:n};}return function(t,e){return e=N(t,e),L(t,t.getIssuerOrigin()+"/api/v1/authn/introspect",e,{withCredentials:!0})}(t,e).then((function(e){return new q(t,e)}))}function J(t){return !!t.tx.exists._get(l)}function $(t,e,n,r){return L(t,e,n,r).then((function(e){return new q(t,e)}))}var W=function t(){a()(this,t);},X=n(15);function Z(t){return ("0"+t.toString(16)).substr(-2)}var Q={DEFAULT_CODE_CHALLENGE_METHOD:R,generateVerifier:function(t){var e,n,r=t||"";return r.length<E&&(r+=(e=E-r.length,n=new Uint8Array(Math.ceil(e/2)),X.webcrypto.getRandomValues(n),Array.from(n,Z).join("").slice(0,e))),encodeURIComponent(r).slice(0,A)},computeChallenge:function(t){var e=(new TextEncoder).encode(t);return X.webcrypto.subtle.digest("SHA-256",e).then((function(t){var e=String.fromCharCode.apply(null,new Uint8Array(t));return Object(X.stringToBase64Url)(e)}))}};function tt(t){return t.session.get().then((function(t){return "ACTIVE"===t.status})).catch((function(){return !1}))}function et(t){return U(t,"/api/v1/sessions/me",{withCredentials:!0}).then((function(e){var n=Object(C.s)(e,"_links");return n.refresh=function(){return L(t,Object(C.j)(e,"refresh").href,{},{withCredentials:!0})},n.user=function(){return U(t,Object(C.j)(e,"user").href,{withCredentials:!0})},n})).catch((function(){return {status:"INACTIVE"}}))}function nt(t){return M(t,{url:t.getIssuerOrigin()+"/api/v1/sessions/me",method:"DELETE",withCredentials:!0})}function rt(t){return L(t,"/api/v1/sessions/me/lifecycle/refresh",{},{withCredentials:!0})}function ot(t,e,n){n=n||window.location.href,window.location.assign(t.getIssuerOrigin()+"/login/sessionCookieRedirect"+Object(C.w)({checkAccountSetupComplete:!0,token:e,redirectUrl:n}));}var it=n(2);function at(t){if(!t.clientId)throw new it.c("A clientId must be specified in the OktaAuth constructor to get a token");if(Object(C.q)(t.responseType)&&-1!==t.responseType.indexOf(" "))throw new it.c("Multiple OAuth responseTypes must be defined as an array");var e={client_id:t.clientId,code_challenge:t.codeChallenge,code_challenge_method:t.codeChallengeMethod,display:t.display,idp:t.idp,idp_scope:t.idpScope,login_hint:t.loginHint,max_age:t.maxAge,nonce:t.nonce,prompt:t.prompt,redirect_uri:t.redirectUri,response_mode:t.responseMode,response_type:t.responseType,sessionToken:t.sessionToken,state:t.state};if(e=Object(C.t)(e),["idp_scope","response_type"].forEach((function(t){Array.isArray(e[t])&&(e[t]=e[t].join(" "));})),-1!==t.responseType.indexOf("id_token")&&-1===t.scopes.indexOf("openid"))throw new it.c("openid scope must be specified in the scopes argument when requesting an id_token");return e.scope=t.scopes.join(" "),e}function ut(t){var e=at(t);return Object(C.w)(e)}var st=n(129),ct=n.n(st);function ft(t,e,n){!function(t){if(!t.clientId)throw new it.c("A clientId must be specified in the OktaAuth constructor to get a token");if(!t.redirectUri)throw new it.c("The redirectUri passed to /authorize must also be passed to /token");if(!t.authorizationCode&&!t.interactionCode)throw new it.c("An authorization code (returned from /authorize) must be passed to /token");if(!t.codeVerifier)throw new it.c('The "codeVerifier" (generated and saved by your app) must be passed to /token')}(e);var r=function(t,e){var n=Object(C.t)({client_id:e.clientId,redirect_uri:e.redirectUri,grant_type:e.interactionCode?"interaction_code":"authorization_code",code_verifier:e.codeVerifier});e.interactionCode?n.interaction_code=e.interactionCode:e.authorizationCode&&(n.code=e.authorizationCode);var r=t.options.clientSecret;return r&&(n.client_secret=r),Object(C.w)(n).slice(1)}(t,e);return M(t,{url:n.tokenUrl,method:"POST",args:r,headers:{"Content-Type":"application/x-www-form-urlencoded"}})}function lt(t,e,n){return M(t,{url:n.tokenUrl,method:"POST",headers:{"Content-Type":"application/x-www-form-urlencoded"},args:Object.entries({client_id:e.clientId,grant_type:"refresh_token",scope:n.scopes.join(" "),refresh_token:n.refreshToken}).map((function(t){var e=ct()(t,2),n=e[0],r=e[1];return n+"="+encodeURIComponent(r)})).join("&")})}function ht(t,e){return U(t,(e||t.options.issuer)+"/.well-known/openid-configuration",{cacheResponse:!0})}function pt(t,e,n){var r=t.storageManager.getHttpCache(t.options.cookies);return ht(t,e).then((function(e){var o=e.jwks_uri,i=r.getStorage()[o];if(i&&Date.now()/1e3<i.expiresAt){var a=Object(C.g)(i.response.keys,{kid:n});if(a)return a}return r.clearStorage(o),U(t,o,{cacheResponse:!0}).then((function(t){var e=Object(C.g)(t.keys,{kid:n});if(e)return e;throw new F.a("The key id, "+n+", was not found in the server's keys")}))}))}var dt=n(10);function vt(t,e,n){t.addEventListener?t.addEventListener(e,n):t.attachEvent("on"+e,n);}function yt(t,e,n){t.removeEventListener?t.removeEventListener(e,n):t.detachEvent("on"+e,n);}function gt(t){var e=document.createElement("iframe");return e.style.display="none",e.src=t,document.body.appendChild(e)}function mt(t,e){var n=e.popupTitle||"External Identity Provider User Authentication",r="toolbar=no, scrollbars=yes, resizable=yes, top=100, left=500, width=600, height=600";if(Object(dt.isIE11OrLess)()){var o=window.open("/",n,r);return o.location.href=t,o}return window.open(t,n,r)}function bt(t,e,n){var r,o;return new Promise((function(i,a){r=function(e){if(e.data&&e.data.state===n)return e.origin!==t.getIssuerOrigin()?a(new it.c("The request does not match client configuration")):void i(e.data)},vt(window,"message",r),o=setTimeout((function(){a(new it.c("OAuth flow timed out"));}),e||12e4);})).finally((function(){clearTimeout(o),yt(window,"message",r);}))}function wt(){return Object(C.h)(64)}function xt(){return Object(C.h)(64)}function kt(t){var e=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{},n=Object(C.u)(e.issuer)||t.options.issuer;return n}function Ot(t){var e=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{},n=kt(t,e),r=n.indexOf("/oauth2")>0?n:n+"/oauth2";return r}function St(t){var e=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{},n=kt(t,e),r=n.split("/oauth2")[0];return r}function Tt(t,e){if(arguments.length>2)throw new F.a('As of version 3.0, "getOAuthUrls" takes only a single set of options');e=e||{};var n=Object(C.u)(e.authorizeUrl)||t.options.authorizeUrl,r=kt(t,e),o=Object(C.u)(e.userinfoUrl)||t.options.userinfoUrl,i=Object(C.u)(e.tokenUrl)||t.options.tokenUrl,a=Object(C.u)(e.logoutUrl)||t.options.logoutUrl,u=Object(C.u)(e.revokeUrl)||t.options.revokeUrl,s=Ot(t,e);return {issuer:r,authorizeUrl:n=n||s+"/v1/authorize",userinfoUrl:o=o||s+"/v1/userinfo",tokenUrl:i=i||s+"/v1/token",revokeUrl:u=u||s+"/v1/revoke",logoutUrl:a=a||s+"/v1/logout"}}function _t(t){var e=t.options,n=e.pkce,r=e.clientId,o=e.redirectUri,i=e.responseType,a=e.responseMode,u=e.scopes,s=e.state,c=e.ignoreSignature,f=Object(dt.isBrowser)()?window.location.href:void 0;return Object(C.t)({pkce:n,clientId:r,redirectUri:o||f,responseType:i||["token","id_token"],responseMode:a,state:s||wt(),nonce:xt(),scopes:u||["openid","email"],ignoreSignature:c})}function Et(t){return "OAuthError"===t.name&&"interaction_required"===t.errorCode}function At(t,e){if("AuthApiError"!==e.name)return !1;var n=e.xhr,r=null==n?void 0:n.responseJSON;return t.options.pkce&&"invalid_grant"===(null==r?void 0:r.error)}function Rt(t){return /((id|access)_token=)/i.test(t)}function jt(t){return /(code=)/i.test(t)}function Pt(t){return /(interaction_code=)/i.test(t)}function Ct(t){return /(error=)/i.test(t)||/(error_description)/i.test(t)}function It(t,e){var n=e.options;return t&&0===t.indexOf(n.redirectUri)}function Mt(t){return t.pkce||"code"===t.responseType||"query"===t.responseMode}function Ut(t){return Mt(t)&&"fragment"!==t.responseMode?window.location.search:window.location.hash}function Lt(t){if(!It(window.location.href,t))return !1;var e=Mt(t.options),n=Ut(t.options);return !!Ct(n)||(e?jt(n)||Pt(n):Rt(window.location.hash))}function Ft(t){if(!Lt(t))return !1;var e=Ut(t.options);return /(error=interaction_required)/i.test(e)}function Nt(t,e){var n=_t(t);if(!1===(e=Object.assign({},n,Object(C.b)(e))).pkce)return Promise.resolve(e);if(!t.features.isPKCESupported()){var r="PKCE requires a modern browser with encryption support running in a secure context.";return t.features.isHTTPS()||(r+="\nThe current page is not being served with HTTPS protocol. PKCE requires secure HTTPS protocol."),t.features.hasTextEncoder()||(r+='\n"TextEncoder" is not defined. To use PKCE, you may need to include a polyfill/shim for this browser.'),Promise.reject(new it.c(r))}return e.codeChallengeMethod||(e.codeChallengeMethod=R),e.responseType="code",ht(t,null).then((function(t){if(-1===(t.code_challenge_methods_supported||[]).indexOf(e.codeChallengeMethod))throw new it.c("Invalid code_challenge_method")})).then((function(){return e.codeVerifier||(e.codeVerifier=Q.generateVerifier()),Q.computeChallenge(e.codeVerifier)})).then((function(t){var n=Object(C.b)(e)||{};return Object.assign(n,e,{codeChallenge:t}),n}))}function Dt(t,e){return t.refreshToken===e.refreshToken}function Bt(t){return !!Object(it.e)(t)&&(!(!t.xhr||!t.xhr.responseJSON)&&"invalid_grant"===t.xhr.responseJSON.error)}function Ht(t){var e=/\+/g,n=/([^&=]+)=?([^&]*)/g,r=t;"#"===r.charAt(0)&&"/"===r.charAt(1)&&(r=r.substring(2)),"#"!==r.charAt(0)&&"?"!==r.charAt(0)||(r=r.substring(1));for(var o,i={};o=n.exec(r);){var a=o[1],u=o[2];i[a]="id_token"===a||"access_token"===a||"code"===a?u:decodeURIComponent(u.replace(e," "));}return i}function qt(t,e,n){var r=n.clientId,o=n.issuer,i=n.nonce;if(!e||!o||!r)throw new F.a("The jwt, iss, and aud arguments are all required");if(i&&e.nonce!==i)throw new F.a("OAuth flow response nonce doesn't match request nonce");var a=Math.floor(Date.now()/1e3);if(e.iss!==o)throw new F.a("The issuer ["+e.iss+"] does not match ["+o+"]");if(e.aud!==r)throw new F.a("The audience ["+e.aud+"] does not match ["+r+"]");if(e.iat>e.exp)throw new F.a("The JWT expired before it was issued");if(a-t.options.maxClockSkew>e.exp)throw new F.a("The JWT expired and is no longer valid");if(e.iat>a+t.options.maxClockSkew)throw new F.a("The JWT was issued in the future")}var Kt,Vt,zt=n(30),Yt=n.n(zt);function Gt(t){return !(!t||"object"!==Yt()(t)||0===Object.values(t).length)}function Jt(t){return !!Gt(t)&&(!!t.redirectUri||!!t.responseType)}function $t(t){return !!Jt(t)&&!!t.codeVerifier}function Wt(t){return !!$t(t)&&!!t.interactionHandle}function Xt(t){return !!Gt(t)&&void 0===Object.values(t).find((function(t){return "string"!=typeof t}))}function Zt(t){return !(!Jt(t)&&!Xt(t))}function Qt(t){return !!(t&&(t.accessToken||t.idToken||t.refreshToken)&&Array.isArray(t.scopes))}function te(t){return t&&t.accessToken}function ee(t){return t&&t.idToken}function ne(t){return t&&t.refreshToken}function re(t,e){if(!ee(t)&&!te(t)&&!ne(t))throw new it.c("Token must be an Object with scopes, expiresAt, and one of: an idToken, accessToken, or refreshToken property");if("accessToken"===e&&!te(t))throw new it.c("invalid accessToken");if("idToken"===e&&!ee(t))throw new it.c("invalid idToken");if("refreshToken"===e&&!ne(t))throw new it.c("invalid refreshToken")}function oe(t){var e,n=t.split(".");try{e={header:JSON.parse(Object(X.base64UrlToString)(n[0])),payload:JSON.parse(Object(X.base64UrlToString)(n[1])),signature:n[2]};}catch(t){throw new it.c("Malformed token")}return e}function ie(t,e){return Promise.resolve().then((function(){var n,r;if(e&&(n=e.accessToken,r=e.refreshToken),!n&&!r)throw new F.a("A valid access or refresh token object is required");var o=t.options.clientId,i=t.options.clientSecret;if(!o)throw new F.a("A clientId must be specified in the OktaAuth constructor to revoke a token");var a=Tt(t).revokeUrl,u=Object(C.w)({token_type_hint:r?"refresh_token":"access_token",token:r||n}).slice(1),s=i?Object(X.btoa)("".concat(o,":").concat(i)):Object(X.btoa)(o);return L(t,a,u,{headers:{"Content-Type":"application/x-www-form-urlencoded",Authorization:"Basic "+s}})}))}function ae(t,e,n){n=n||Tt(t,e);var r=e=Object.assign({},_t(t),Object(C.b)(e)),o=r.authorizationCode,i=r.interactionCode,a=r.codeVerifier,u=r.clientId,s=r.redirectUri,c=r.scopes,f=r.ignoreSignature,l=r.state;return ft(t,{clientId:u,redirectUri:s,authorizationCode:o,interactionCode:i,codeVerifier:a},n).then((function(e){var r=["token"];return -1!==c.indexOf("openid")&&r.push("id_token"),ce(t,{clientId:u,redirectUri:s,scopes:c,responseType:r,ignoreSignature:f},e,n).then((function(t){return t.code=o,t.state=l,t}))})).finally((function(){t.transactionManager.clear();}))}!function(t){t[t.SUCCESS=0]="SUCCESS",t[t.PENDING=1]="PENDING",t[t.FAILURE=2]="FAILURE",t[t.TERMINAL=3]="TERMINAL",t[t.CANCELED=4]="CANCELED";}(Kt||(Kt={})),function(t){t[t.PASSWORD_RECOVERY=0]="PASSWORD_RECOVERY",t[t.REGISTRATION=1]="REGISTRATION",t[t.SOCIAL_IDP=2]="SOCIAL_IDP";}(Vt||(Vt={}));var ue=function(t,e,n,r){return new(n||(n=Promise))((function(o,i){function a(t){try{s(r.next(t));}catch(t){i(t);}}function u(t){try{s(r.throw(t));}catch(t){i(t);}}function s(t){var e;t.done?o(t.value):(e=t.value,e instanceof n?e:new n((function(t){t(e);}))).then(a,u);}s((r=r.apply(t,e||[])).next());}))};function se(t,e,n){return ue(this,void 0,void 0,f.a.mark((function r(){var o,i,a,u,s,c;return f.a.wrap((function(r){for(;;)switch(r.prev=r.next){case 0:if(e&&e.idToken){r.next=2;break}throw new it.c("Only idTokens may be verified");case 2:return o=oe(e.idToken),i=(null==n?void 0:n.issuer)||t.options.issuer,r.next=6,ht(t,i);case 6:if(a=r.sent,u=a.issuer,s=Object.assign({clientId:t.options.clientId,ignoreSignature:t.options.ignoreSignature},n,{issuer:u}),qt(t,o.payload,s),1!=s.ignoreSignature&&t.features.isTokenVerifySupported()){r.next=12;break}return r.abrupt("return",e);case 12:return r.next=14,pt(t,e.issuer,o.header.kid);case 14:return c=r.sent,r.next=17,X.verifyToken(e.idToken,c);case 17:if(r.sent){r.next=20;break}throw new it.c("The token signature is not valid");case 20:if(!(n&&n.accessToken&&e.claims.at_hash)){r.next=26;break}return r.next=23,X.getOidcHash(n.accessToken);case 23:if(r.sent===e.claims.at_hash){r.next=26;break}throw new it.c("Token hash verification failed");case 26:return r.abrupt("return",e);case 27:case"end":return r.stop()}}),r)})))}function ce(t,e,n,r){if(!1!==t.options.pkce&&(n.code||n.interaction_code))return ae(t,Object.assign({},e,{authorizationCode:n.code,interactionCode:n.interaction_code}),r);e=e||_t(t),r=r||Tt(t,e);var o,i=e.responseType;Array.isArray(i)||(i=[i]),o=n.scope?n.scope.split(" "):Object(C.b)(e.scopes);var a=e.clientId||t.options.clientId;return Promise.resolve().then((function(){!function(t,e){if(t.error||t.error_description)throw new it.d(t.error,t.error_description);if(t.state!==e.state)throw new it.c("OAuth flow response state doesn't match request state")}(n,e);})).then((function(){var i={},u=n.expires_in,s=n.token_type,c=n.access_token,f=n.id_token,l=n.refresh_token,h=Math.floor(Date.now()/1e3);if(c){var p=t.token.decode(c);i.accessToken={accessToken:c,claims:p.payload,expiresAt:Number(u)+h,tokenType:s,scopes:o,authorizeUrl:r.authorizeUrl,userinfoUrl:r.userinfoUrl};}if(l&&(i.refreshToken={refreshToken:l,expiresAt:Number(u)+h,scopes:o,tokenUrl:r.tokenUrl,authorizeUrl:r.authorizeUrl,issuer:r.issuer}),f){var d=t.token.decode(f),v={idToken:f,claims:d.payload,expiresAt:d.payload.exp-d.payload.iat+h,scopes:o,authorizeUrl:r.authorizeUrl,issuer:r.issuer,clientId:a},y={clientId:a,issuer:r.issuer,nonce:e.nonce,accessToken:c};return void 0!==e.ignoreSignature&&(y.ignoreSignature=e.ignoreSignature),se(t,v,y).then((function(){return i.idToken=v,i}))}return i})).then((function(t){if(-1!==i.indexOf("token")&&!t.accessToken)throw new it.c('Unable to parse OAuth flow response: response type "token" was requested but "access_token" was not returned.');if(-1!==i.indexOf("id_token")&&!t.idToken)throw new it.c('Unable to parse OAuth flow response: response type "id_token" was requested but "id_token" was not returned.');return {tokens:t,state:n.state,code:n.code}}))}function fe(t,e){return arguments.length>2?Promise.reject(new F.a('As of version 3.0, "getToken" takes only a single set of options')):Nt(t,e=e||{}).then((function(n){var r,o;switch(e.sessionToken?Object.assign(n,{prompt:"none",responseMode:"okta_post_message",display:null}):e.idp&&Object.assign(n,{display:"popup"}),o=Tt(t,n),r=(e.codeVerifier?o.tokenUrl:o.authorizeUrl)+ut(n),n.sessionToken||null===n.display?"IFRAME":"popup"===n.display?"POPUP":"IMPLICIT"){case"IFRAME":var i=bt(t,e.timeout,n.state),a=gt(r);return i.then((function(e){return ce(t,n,e,o)})).finally((function(){document.body.contains(a)&&a.parentElement.removeChild(a);}));case"POPUP":var u;if("okta_post_message"===n.responseMode){if(!t.features.isPopupPostMessageSupported())throw new F.a("This browser doesn't have full postMessage support");u=bt(t,e.timeout,n.state);}var s=mt(r,{popupTitle:e.popupTitle});return new Promise((function(t,e){var n=setInterval((function(){s&&!s.closed||(clearInterval(n),e(new F.a("Unable to parse OAuth flow response")));}),100);u.then((function(e){clearInterval(n),t(e);})).catch((function(t){clearInterval(n),e(t);}));})).then((function(e){return ce(t,n,e,o)})).finally((function(){s&&!s.closed&&s.close();}));default:throw new F.a("The full page redirect flow is not supported")}}))}function le(t,e){return arguments.length>2?Promise.reject(new it.c('As of version 3.0, "getWithoutPrompt" takes only a single set of options')):(e=Object(C.b)(e)||{},Object.assign(e,{prompt:"none",responseMode:"okta_post_message",display:null}),fe(t,e))}var he=function(t,e,n,r){return new(n||(n=Promise))((function(o,i){function a(t){try{s(r.next(t));}catch(t){i(t);}}function u(t){try{s(r.throw(t));}catch(t){i(t);}}function s(t){var e;t.done?o(t.value):(e=t.value,e instanceof n?e:new n((function(t){t(e);}))).then(a,u);}s((r=r.apply(t,e||[])).next());}))};function pe(t,e,n){return he(this,void 0,void 0,f.a.mark((function r(){var o,i,a,u,s,c,l;return f.a.wrap((function(r){for(;;)switch(r.prev=r.next){case 0:if(o=t.options.clientId){r.next=3;break}throw new it.c("A clientId must be specified in the OktaAuth constructor to renew tokens");case 3:return i=Object.assign({},e,{clientId:o}),r.next=6,lt(t,i,n);case 6:return a=r.sent,u=Tt(t,e),r.next=10,ce(t,i,a,u);case 10:return s=r.sent,c=s.tokens,(l=c.refreshToken)&&!Dt(l,n)&&t.tokenManager.updateRefreshToken(l),r.abrupt("return",c);case 15:case"end":return r.stop()}}),r)})))}var de=function(t,e,n,r){return new(n||(n=Promise))((function(o,i){function a(t){try{s(r.next(t));}catch(t){i(t);}}function u(t){try{s(r.throw(t));}catch(t){i(t);}}function s(t){var e;t.done?o(t.value):(e=t.value,e instanceof n?e:new n((function(t){t(e);}))).then(a,u);}s((r=r.apply(t,e||[])).next());}))};function ve(){throw new it.c("Renew must be passed a token with an array of scopes and an accessToken or idToken")}function ye(t,e){return ee(t)?e.idToken:te(t)?e.accessToken:void ve()}function ge(t,e){return de(this,void 0,void 0,f.a.mark((function n(){var r,o,i,a,u,s;return f.a.wrap((function(n){for(;;)switch(n.prev=n.next){case 0:if(ee(e)||te(e)||ve(),!(r=t.tokenManager.getTokensSync()).refreshToken){n.next=7;break}return n.next=5,pe(t,{scopes:e.scopes},r.refreshToken);case 5:return r=n.sent,n.abrupt("return",ye(e,r));case 7:return o=t.options.pkce?"code":te(e)?"token":"id_token",i=e.scopes,a=e.authorizeUrl,u=e.userinfoUrl,s=e.issuer,n.abrupt("return",le(t,{responseType:o,scopes:i,authorizeUrl:a,userinfoUrl:u,issuer:s}).then((function(t){return ye(e,t.tokens)})));case 10:case"end":return n.stop()}}),n)})))}var me=function(t,e,n,r){return new(n||(n=Promise))((function(o,i){function a(t){try{s(r.next(t));}catch(t){i(t);}}function u(t){try{s(r.throw(t));}catch(t){i(t);}}function s(t){var e;t.done?o(t.value):(e=t.value,e instanceof n?e:new n((function(t){t(e);}))).then(a,u);}s((r=r.apply(t,e||[])).next());}))};function be(t,e){return me(this,void 0,void 0,f.a.mark((function n(){var r,o,i;return f.a.wrap((function(n){for(;;)switch(n.prev=n.next){case 0:if(!(r=t.tokenManager.getTokensSync()).refreshToken){n.next=3;break}return n.abrupt("return",pe(t,e,r.refreshToken));case 3:return e=Object.assign({scopes:t.options.scopes,authorizeUrl:t.options.authorizeUrl,userinfoUrl:t.options.userinfoUrl,issuer:t.options.issuer},e),t.options.pkce?e.responseType="code":(o=_t(t),i=o.responseType,e.responseType=i),n.abrupt("return",le(t,e).then((function(t){return t.tokens})));case 6:case"end":return n.stop()}}),n)})))}var we=function(t,e,n,r){return new(n||(n=Promise))((function(o,i){function a(t){try{s(r.next(t));}catch(t){i(t);}}function u(t){try{s(r.throw(t));}catch(t){i(t);}}function s(t){var e;t.done?o(t.value):(e=t.value,e instanceof n?e:new n((function(t){t(e);}))).then(a,u);}s((r=r.apply(t,e||[])).next());}))};function xe(t,e,n){return we(this,void 0,void 0,f.a.mark((function r(){return f.a.wrap((function(r){for(;;)switch(r.prev=r.next){case 0:if(e){r.next=4;break}return r.next=3,t.tokenManager.getTokens();case 3:e=r.sent.accessToken;case 4:if(n){r.next=8;break}return r.next=7,t.tokenManager.getTokens();case 7:n=r.sent.idToken;case 8:if(e&&te(e)){r.next=10;break}return r.abrupt("return",Promise.reject(new it.c("getUserInfo requires an access token object")));case 10:if(n&&ee(n)){r.next=12;break}return r.abrupt("return",Promise.reject(new it.c("getUserInfo requires an ID token object")));case 12:return r.abrupt("return",M(t,{url:e.userinfoUrl,method:"GET",accessToken:e.accessToken}).then((function(t){return t.sub===n.claims.sub?t:Promise.reject(new it.c("getUserInfo request was rejected due to token mismatch"))})).catch((function(t){var e;if(t.xhr&&(401===t.xhr.status||403===t.xhr.status)&&(t.xhr.headers&&Object(C.m)(t.xhr.headers.get)&&t.xhr.headers.get("WWW-Authenticate")?e=t.xhr.headers.get("WWW-Authenticate"):Object(C.m)(t.xhr.getResponseHeader)&&(e=t.xhr.getResponseHeader("WWW-Authenticate")),e)){var n=e.match(/error="(.*?)"/)||[],r=e.match(/error_description="(.*?)"/)||[],o=n[1],i=r[1];o&&i&&(t=new it.d(o,i));}throw t})));case 13:case"end":return r.stop()}}),r)})))}function ke(t,e){return arguments.length>2?Promise.reject(new it.c('As of version 3.0, "getWithPopup" takes only a single set of options')):(e=Object(C.b)(e)||{},Object.assign(e,{display:"popup",responseMode:"okta_post_message"}),fe(t,e))}function Oe(t,e){return arguments.length>2?Promise.reject(new it.c('As of version 3.0, "getWithRedirect" takes only a single set of options')):(e=Object(C.b)(e)||{},Nt(t,e).then((function(n){var r=Tt(t,e),o=r.authorizeUrl+ut(n),i={issuer:t.options.issuer,responseType:n.responseType,state:n.state,nonce:n.nonce,scopes:n.scopes,clientId:n.clientId,urls:r,ignoreSignature:n.ignoreSignature,redirectUri:n.redirectUri,codeVerifier:n.codeVerifier,codeChallenge:n.codeChallenge,codeChallengeMethod:n.codeChallengeMethod};t.transactionManager.save(i,{oauth:!0}),t.token.getWithRedirect._setLocation(o);})))}function Se(t,e){e=e||{},e=Object(C.q)(e)?{url:e}:e;var n,r=t.options.pkce?"query":"fragment",o=e.url,i=e.responseMode||t.options.responseMode||r,a=t.token.parseFromUrl._getLocation();if(!(n="query"===i?o?o.substring(o.indexOf("?")):a.search:o?o.substring(o.indexOf("#")):a.hash))return Promise.reject(new it.c("Unable to parse a token from the url"));var u=t.transactionManager.load({oauth:!0,pkce:t.options.pkce}),s=u.urls;return delete u.urls,Promise.resolve(Ht(n)).then((function(e){return o||("query"===i?function(t){var e=t.token.parseFromUrl._getHistory(),n=t.token.parseFromUrl._getDocument(),r=t.token.parseFromUrl._getLocation();e&&e.replaceState?e.replaceState(null,n.title,r.pathname+r.hash):r.search="";}(t):function(t){var e=t.token.parseFromUrl._getHistory(),n=t.token.parseFromUrl._getDocument(),r=t.token.parseFromUrl._getLocation();e&&e.replaceState?e.replaceState(null,n.title,r.pathname+r.search):r.hash="";}(t)),ce(t,u,e,s).catch((function(e){throw Et(e)||t.transactionManager.clear(),e})).then((function(e){return t.transactionManager.clear(),e}))}))}var Te=n(216),_e={getHttpCache:function(){return null},getPKCEStorage:function(){return null},browserHasLocalStorage:function(){try{var t=_e.getLocalStorage();return _e.testStorage(t)}catch(t){return !1}},browserHasSessionStorage:function(){try{var t=_e.getSessionStorage();return _e.testStorage(t)}catch(t){return !1}},testStorageType:function(t){var e=!1;switch(t){case"sessionStorage":e=_e.browserHasSessionStorage();break;case"localStorage":e=_e.browserHasLocalStorage();break;case"cookie":case"memory":e=!0;break;default:e=!1;}return e},getStorageByType:function(t,e){var n=null;switch(t){case"sessionStorage":n=_e.getSessionStorage();break;case"localStorage":n=_e.getLocalStorage();break;case"cookie":n=_e.getCookieStorage(e);break;case"memory":n=_e.getInMemoryStorage();break;default:throw new F.a("Unrecognized storage option: ".concat(t))}return n},findStorageType:function(t){var e,n;return e=(t=t.slice()).shift(),(n=t.length?t[0]:null)?_e.testStorageType(e)?e:(Object(C.y)("This browser doesn't support ".concat(e,". Switching to ").concat(n,".")),_e.findStorageType(t)):e},getLocalStorage:function(){return localStorage},getSessionStorage:function(){return sessionStorage},getCookieStorage:function(t){var e=t.secure,n=t.sameSite,r=t.sessionCookie;if(void 0===e||void 0===n)throw new F.a('getCookieStorage: "secure" and "sameSite" options must be provided');var o={getItem:_e.storage.get,setItem:function(t,o){var i=arguments.length>2&&void 0!==arguments[2]?arguments[2]:"2200-01-01T00:00:00.000Z";i=r?null:i,_e.storage.set(t,o,i,{secure:e,sameSite:n});},removeItem:function(t){_e.storage.delete(t);}};return t.useMultipleCookies?{getItem:function(t){var e=o.getItem(),n={};return Object.keys(e).forEach((function(r){0===r.indexOf(t)&&(n[r.replace("".concat(t,"_"),"")]=JSON.parse(e[r]));})),JSON.stringify(n)},setItem:function(t,e){var n=JSON.parse(this.getItem(t));e=JSON.parse(e),Object.keys(e).forEach((function(r){var i=t+"_"+r,a=JSON.stringify(e[r]);o.setItem(i,a),delete n[r];})),Object.keys(n).forEach((function(e){o.removeItem(t+"_"+e);}));},removeItem:function(t){var e=JSON.parse(this.getItem(t));Object.keys(e).forEach((function(e){o.removeItem(t+"_"+e);}));}}:o},getInMemoryStorage:function(){var t={};return {getItem:function(e){return t[e]},setItem:function(e,n){t[e]=n;}}},testStorage:function(t){var e="okta-test-storage";try{return t.setItem(e,e),t.removeItem(e),!0}catch(t){return !1}},storage:{set:function(t,e,n,r){var o=r.sameSite,i=r.secure;if(void 0===i||void 0===o)throw new F.a('storage.set: "secure" and "sameSite" options must be provided');var a={path:r.path||"/",secure:i,sameSite:o};return Date.parse(n)&&(a.expires=new Date(n)),Te.set(t,e,a),_e.storage.get(t)},get:function(t){return Te.get(t)},delete:function(t){return Te.remove(t,{path:"/"})}}},Ee=_e;function Ae(t){var e=(t=t||{}).issuer;if(!e)throw new F.a('No issuer passed to constructor. Required usage: new OktaAuth({issuer: "https://{yourOktaDomain}.com/oauth2/{authServerId}"})');if(!new RegExp("^http?s?://.+").test(t.issuer))throw new F.a('Issuer must be a valid URL. Required usage: new OktaAuth({issuer: "https://{yourOktaDomain}.com/oauth2/{authServerId}"})');if(-1!==e.indexOf("-admin."))throw new F.a('Issuer URL passed to constructor contains "-admin" in subdomain. Required usage: new OktaAuth({issuer: "https://{yourOktaDomain}.com})')}function Re(t,e){var n=t.userAgent||{};return n.value?n.value:n.template?n.template.replace("$OKTA_AUTH_JS",e):e}var je=function(){function t(e){a()(this,t),this.localOffset=parseInt(e||0);}return s()(t,[{key:"now",value:function(){var t=(Date.now()+this.localOffset)/1e3;return t}}],[{key:"create",value:function(){return new t(0)}}]),t}();var Pe=function(){function t(e){var n=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{};a()(this,t),this.tokenManager=e,this.options=n;}return s()(t,[{key:"start",value:function(){var t=this,e=[];this.onTokenExpiredHandler=function(n){if(t.options.autoRenew)if(function(t){var e=!1;if(t.push(Date.now()),t.length>=10){var n=t.shift();e=t[t.length-1]-n<3e4;}return e}(e)){var r=new it.c("Too many token renew requests");t.tokenManager.emitError(r);}else t.tokenManager.renew(n).catch((function(){}));else t.options.autoRemove&&t.tokenManager.remove(n);},this.tokenManager.on(Me,this.onTokenExpiredHandler),this.tokenManager.setExpireEventTimeoutAll(),this.options.syncStorage&&Object(dt.isBrowser)()&&(this.storageListener=function(e){var n=e.key,r=e.newValue,o=e.oldValue;(!n||n===t.options.storageKey&&r!==o)&&(t.syncTimeout=setTimeout((function(){return t.tokenManager.resetExpireEventTimeoutAll(),void t.tokenManager.emitEventsForCrossTabsStorageUpdate(r,o)}),t.options._storageEventDelay));},window.addEventListener("storage",this.storageListener));}},{key:"stop",value:function(){this.tokenManager.clearExpireEventTimeoutAll(),this.tokenManager.off(Me,this.onTokenExpiredHandler),this.options.syncStorage&&Object(dt.isBrowser)()&&(window.removeEventListener("storage",this.storageListener),clearTimeout(this.syncTimeout));}}]),t}(),Ce=function(t,e,n,r){return new(n||(n=Promise))((function(o,i){function a(t){try{s(r.next(t));}catch(t){i(t);}}function u(t){try{s(r.throw(t));}catch(t){i(t);}}function s(t){var e;t.done?o(t.value):(e=t.value,e instanceof n?e:new n((function(t){t(e);}))).then(a,u);}s((r=r.apply(t,e||[])).next());}))},Ie={autoRenew:!0,autoRemove:!0,storage:void 0,expireEarlySeconds:30,storageKey:m,syncStorage:!0,_storageEventDelay:0},Me="expired",Ue="renewed",Le="added",Fe="removed",Ne="error";var De=function(){function t(e){var n=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{};if(a()(this,t),this.sdk=e,this.emitter=e.emitter,!this.emitter)throw new it.c("Emitter should be initialized before TokenManager");n=Object.assign({},Ie,Object(C.t)(n)),Object(dt.isIE11OrLess)()&&(n._storageEventDelay=n._storageEventDelay||1e3),Object(dt.isLocalhost)()||(n.expireEarlySeconds=Ie.expireEarlySeconds),this.options=n;var r=Object(C.t)({storageKey:n.storageKey,secure:n.secure});"object"===Yt()(n.storage)?r.storageProvider=n.storage:n.storage&&(r.storageType=n.storage),this.storage=e.storageManager.getTokenStorage(r),this.clock=je.create(),this.state={expireTimeouts:{},renewPromise:null},this.on=this.emitter.on.bind(this.emitter),this.off=this.emitter.off.bind(this.emitter);}return s()(t,[{key:"start",value:function(){this.service&&this.stop(),this.service=new Pe(this,this.getOptions()),this.service.start();}},{key:"stop",value:function(){this.service&&(this.service.stop(),this.service=null);}},{key:"getOptions",value:function(){return Object(C.b)(this.options)}},{key:"getExpireTime",value:function(t){return t.expiresAt-this.options.expireEarlySeconds}},{key:"hasExpired",value:function(t){return this.getExpireTime(t)<=this.clock.now()}},{key:"emitExpired",value:function(t,e){this.emitter.emit(Me,t,e);}},{key:"emitRenewed",value:function(t,e,n){this.emitter.emit(Ue,t,e,n);}},{key:"emitAdded",value:function(t,e){this.emitter.emit(Le,t,e);}},{key:"emitRemoved",value:function(t,e){this.emitter.emit(Fe,t,e);}},{key:"emitError",value:function(t){this.emitter.emit(Ne,t);}},{key:"emitEventsForCrossTabsStorageUpdate",value:function(t,e){var n=this,r=this.getTokensFromStorageValue(e),o=this.getTokensFromStorageValue(t);Object.keys(o).forEach((function(t){var e=r[t],i=o[t];JSON.stringify(e)!==JSON.stringify(i)&&n.emitAdded(t,i);})),Object.keys(r).forEach((function(t){var e=r[t];o[t]||n.emitRemoved(t,e);}));}},{key:"clearExpireEventTimeout",value:function(t){clearTimeout(this.state.expireTimeouts[t]),delete this.state.expireTimeouts[t],this.state.renewPromise=null;}},{key:"clearExpireEventTimeoutAll",value:function(){var t=this.state.expireTimeouts;for(var e in t)Object.prototype.hasOwnProperty.call(t,e)&&this.clearExpireEventTimeout(e);}},{key:"setExpireEventTimeout",value:function(t,e){var n=this;if(!ne(e)){var r=this.getExpireTime(e),o=1e3*Math.max(r-this.clock.now(),0);this.clearExpireEventTimeout(t);var i=setTimeout((function(){n.emitExpired(t,e);}),o);this.state.expireTimeouts[t]=i;}}},{key:"setExpireEventTimeoutAll",value:function(){var t=this.storage.getStorage();for(var e in t)if(Object.prototype.hasOwnProperty.call(t,e)){var n=t[e];this.setExpireEventTimeout(e,n);}}},{key:"resetExpireEventTimeoutAll",value:function(){this.clearExpireEventTimeoutAll(),this.setExpireEventTimeoutAll();}},{key:"add",value:function(t,e){var n=this.storage.getStorage();re(e),n[t]=e,this.storage.setStorage(n),this.emitAdded(t,e),this.setExpireEventTimeout(t,e);}},{key:"getSync",value:function(t){return this.storage.getStorage()[t]}},{key:"get",value:function(t){return Ce(this,void 0,void 0,f.a.mark((function e(){return f.a.wrap((function(e){for(;;)switch(e.prev=e.next){case 0:return e.abrupt("return",this.getSync(t));case 1:case"end":return e.stop()}}),e,this)})))}},{key:"getTokensSync",value:function(){var t={},e=this.storage.getStorage();return Object.keys(e).forEach((function(n){var r=e[n];te(r)?t.accessToken=r:ee(r)?t.idToken=r:ne(r)&&(t.refreshToken=r);})),t}},{key:"getTokens",value:function(){return Ce(this,void 0,void 0,f.a.mark((function t(){return f.a.wrap((function(t){for(;;)switch(t.prev=t.next){case 0:return t.abrupt("return",this.getTokensSync());case 1:case"end":return t.stop()}}),t,this)})))}},{key:"getStorageKeyByType",value:function(t){var e=this.storage.getStorage();return Object.keys(e).filter((function(n){var r=e[n];return te(r)&&"accessToken"===t||ee(r)&&"idToken"===t||ne(r)&&"refreshToken"===t}))[0]}},{key:"getTokenType",value:function(t){if(te(t))return "accessToken";if(ee(t))return "idToken";if(ne(t))return "refreshToken";throw new it.c("Unknown token type")}},{key:"setTokens",value:function(t,e,n,r){var o=this,i=function(t,i){var a=o.getTokenType(i);"accessToken"===a?e&&e(t,i):"idToken"===a?n&&n(t,i):"refreshToken"===a&&r&&r(t,i);},a=function(t,e){o.emitAdded(t,e),o.setExpireEventTimeout(t,e),i(t,e);},u=function(t,e){o.clearExpireEventTimeout(t),o.emitRemoved(t,e),i(t,e);},s=["idToken","accessToken","refreshToken"],c=this.getTokensSync();s.forEach((function(e){var n=t[e];n&&re(n,e);}));var f=s.reduce((function(e,n){var r=t[n];r&&(e[o.getStorageKeyByType(n)||n]=r);return e}),{});this.storage.setStorage(f),s.forEach((function(e){var n,r,s,f=t[e],l=c[e],h=o.getStorageKeyByType(e)||e;f&&l?(u(h,l),a(h,f),n=h,r=f,s=l,o.emitRenewed(n,r,s),o.clearExpireEventTimeout(n),o.setExpireEventTimeout(n,r),i(n,r)):f?a(h,f):l&&u(h,l);}));}},{key:"remove",value:function(t){this.clearExpireEventTimeout(t);var e=this.storage.getStorage(),n=e[t];delete e[t],this.storage.setStorage(e),this.emitRemoved(t,n);}},{key:"renewToken",value:function(t){return Ce(this,void 0,void 0,f.a.mark((function e(){return f.a.wrap((function(e){for(;;)switch(e.prev=e.next){case 0:return e.abrupt("return",this.sdk.token.renew(t));case 1:case"end":return e.stop()}}),e,this)})))}},{key:"validateToken",value:function(t){return re(t)}},{key:"renew",value:function(t){var e=this;if(this.state.renewPromise)return this.state.renewPromise;try{var n=this.getSync(t);if(!n)throw new it.c("The tokenManager has no token for the key: "+t)}catch(t){return Promise.reject(t)}return this.clearExpireEventTimeout(t),this.state.renewPromise=this.sdk.token.renewTokens().then((function(t){return e.setTokens(t),t[e.getTokenType(n)]})).catch((function(n){throw (Bt(n)||"OAuthError"===n.name||"AuthSdkError"===n.name)&&(e.remove(t),n.tokenKey=t,e.emitError(n)),n})).finally((function(){e.state.renewPromise=null;})),this.state.renewPromise}},{key:"clear",value:function(){this.clearExpireEventTimeoutAll(),this.storage.clearStorage();}},{key:"getTokensFromStorageValue",value:function(t){var e;try{e=JSON.parse(t)||{};}catch(t){e={};}return e}},{key:"updateRefreshToken",value:function(t){var e=this.getStorageKeyByType("refreshToken")||T,n=this.storage.getStorage();re(t),n[e]=t,this.storage.setStorage(n);}}]),t}(),Be=function(){function t(){a()(this,t),this.queue=[],this.running=!1;}return s()(t,[{key:"push",value:function(t,e){for(var n=this,r=arguments.length,o=new Array(r>2?r-2:0),i=2;i<r;i++)o[i-2]=arguments[i];return new Promise((function(r,i){n.queue.push({method:t,thisObject:e,args:o,resolve:r,reject:i}),n.run();}))}},{key:"run",value:function(){var t=this;if(!this.running&&0!==this.queue.length){this.running=!0;var e=this.queue.shift(),n=e.method.apply(e.thisObject,e.args);Object(C.p)(n)?n.then(e.resolve,e.reject).finally((function(){t.running=!1,t.run();})):(e.resolve(n),this.running=!1,this.run());}}}]),t}();function He(t,e){return e=e||{},Object(dt.isFingerprintSupported)()?new Promise((function(i,a){(r=document.createElement("iframe")).style.display="none",o=function(e){if(e&&e.data&&e.origin===t.getIssuerOrigin()){try{var n=JSON.parse(e.data);}catch(t){return}if(n)return "FingerprintAvailable"===n.type?i(n.fingerprint):void("FingerprintServiceReady"===n.type&&e.source.postMessage(JSON.stringify({type:"GetFingerprint"}),e.origin))}},vt(window,"message",o),r.src=t.getIssuerOrigin()+"/auth/services/devicefingerprint",document.body.appendChild(r),n=setTimeout((function(){a(new it.c("Fingerprinting timed out"));}),e.timeout||15e3);})).finally((function(){clearTimeout(n),yt(window,"message",o),document.body.contains(r)&&r.parentElement.removeChild(r);})):Promise.reject(new it.c("Fingerprinting is not supported on this device"));var n,r,o;}var qe=function(t,e,n,r){return new(n||(n=Promise))((function(o,i){function a(t){try{s(r.next(t));}catch(t){i(t);}}function u(t){try{s(r.throw(t));}catch(t){i(t);}}function s(t){var e;t.done?o(t.value):(e=t.value,e instanceof n?e:new n((function(t){t(e);}))).then(a,u);}s((r=r.apply(t,e||[])).next());}))},Ke=n(217),Ve=null,ze={updateAuthStatePromise:null,canceledTimes:0},Ye=function(){function t(e){var n=this;if(a()(this,t),!e.emitter)throw new it.c("Emitter should be initialized before AuthStateManager");this._sdk=e,this._pending=Object.assign({},ze),this._authState=Ve,this._logOptions={},e.tokenManager.on(Le,(function(t,e){n._setLogOptions({event:Le,key:t,token:e}),n.updateAuthState();})),e.tokenManager.on(Fe,(function(t,e){n._setLogOptions({event:Fe,key:t,token:e}),n.updateAuthState();}));}return s()(t,[{key:"_setLogOptions",value:function(t){this._logOptions=t;}},{key:"getAuthState",value:function(){return this._authState}},{key:"updateAuthState",value:function(){return qe(this,void 0,void 0,f.a.mark((function t(){var e,n,r,o,i,a,u,s=this;return f.a.wrap((function(t){for(;;)switch(t.prev=t.next){case 0:if(e=this._sdk.options,n=e.transformAuthState,r=e.devMode,o=function(t){var e=s._logOptions,n=e.event,r=e.key,o=e.token;Object(C.i)().group("OKTA-AUTH-JS:updateAuthState: Event:".concat(n," Status:").concat(t)),Object(C.i)().log(r,o),Object(C.i)().log("Current authState",s._authState),Object(C.i)().groupEnd(),s._logOptions={};},i=function(t){var e,n;(e=s._authState,n=t,e&&e.isAuthenticated===n.isAuthenticated&&JSON.stringify(e.idToken)===JSON.stringify(n.idToken)&&JSON.stringify(e.accessToken)===JSON.stringify(n.accessToken)&&e.error===n.error)?r&&o("unchanged"):(s._authState=t,s._sdk.emitter.emit("authStateChange",Object.assign({},t)),r&&o("emitted"));},a=function t(e){return s._pending.updateAuthStatePromise.then((function(){var n=s._pending.updateAuthStatePromise;return n&&n!==e?t(n):s.getAuthState()}))},!this._pending.updateAuthStatePromise){t.next=11;break}if(!(this._pending.canceledTimes>=10)){t.next=10;break}return r&&o("terminated"),t.abrupt("return",a(this._pending.updateAuthStatePromise));case 10:this._pending.updateAuthStatePromise.cancel();case 11:return u=new Ke((function(t,e,a){a.shouldReject=!1,a((function(){s._pending.updateAuthStatePromise=null,s._pending.canceledTimes=s._pending.canceledTimes+1,r&&o("canceled");}));var c=function(e){u.isCanceled?t():(i(e),t(),s._pending=Object.assign({},ze));};s._sdk.isAuthenticated().then((function(){if(u.isCanceled)t();else{var e=s._sdk.tokenManager.getTokensSync(),r=e.accessToken,o=e.idToken,i=e.refreshToken,a={accessToken:r,idToken:o,refreshToken:i,isAuthenticated:!(!r||!o)};(n?n(s._sdk,a):Promise.resolve(a)).then((function(t){return c(t)})).catch((function(t){return c({accessToken:r,idToken:o,refreshToken:i,isAuthenticated:!1,error:t})}));}}));})),this._pending.updateAuthStatePromise=u,t.abrupt("return",a(u));case 14:case"end":return t.stop()}}),t,this)})))}},{key:"subscribe",value:function(t){this._sdk.emitter.on("authStateChange",t);}},{key:"unsubscribe",value:function(t){this._sdk.emitter.off("authStateChange",t);}}]),t}(),Ge=function(){function t(e,n){if(a()(this,t),!e)throw new F.a('"storage" is required');if("string"!=typeof n||!n.length)throw new F.a('"storageName" is required');this.storageName=n,this.storageProvider=e;}return s()(t,[{key:"getItem",value:function(t){return this.getStorage()[t]}},{key:"setItem",value:function(t,e){return this.updateStorage(t,e)}},{key:"removeItem",value:function(t){return this.clearStorage(t)}},{key:"getStorage",value:function(){var t=this.storageProvider.getItem(this.storageName);t=t||"{}";try{return JSON.parse(t)}catch(t){throw new F.a("Unable to parse storage string: "+this.storageName)}}},{key:"setStorage",value:function(t){try{var e=t?JSON.stringify(t):"{}";this.storageProvider.setItem(this.storageName,e);}catch(t){throw new F.a("Unable to set storage: "+this.storageName)}}},{key:"clearStorage",value:function(t){if(t){var e=this.getStorage();delete e[t],this.setStorage(e);}else this.storageProvider.removeItem?this.storageProvider.removeItem(this.storageName):this.setStorage();}},{key:"updateStorage",value:function(t,e){var n=this.getStorage();n[t]=e,this.setStorage(n);}}]),t}();function Je(t){Object(dt.isBrowser)()||t.storageProvider||t.storageProvider||Object(C.y)("Memory storage can only support simple single user use case on server side, please provide custom storageProvider or storageKey if advanced scenarios need to be supported.");}var $e=function(){function t(e,n,r){a()(this,t),this.storageManagerOptions=e,this.cookieOptions=n,this.storageUtil=r;}return s()(t,[{key:"getOptionsForSection",value:function(t,e){return Object.assign({},this.storageManagerOptions[t],e)}},{key:"getStorage",value:function(t){if((t=Object.assign({},this.cookieOptions,t)).storageProvider)return t.storageProvider;var e=t,n=e.storageType,r=e.storageTypes;if("sessionStorage"===n&&(t.sessionCookie=!0),n&&r){var o=r.indexOf(n);o>=0&&(r=r.slice(o),n=null);}return n||(n=this.storageUtil.findStorageType(r)),this.storageUtil.getStorageByType(n,t)}},{key:"getTransactionStorage",value:function(t){Je(t=this.getOptionsForSection("transaction",t));var e=this.getStorage(t),n=t.storageKey||x;return new Ge(e,n)}},{key:"getIdxResponseStorage",value:function(t){var e;if(Object(dt.isBrowser)())try{e=this.storageUtil.getStorageByType("memory",t);}catch(t){Object(C.y)("No response storage found, you may want to provide custom implementation for intermediate idx responses to optimize the network traffic");}else{var n=this.getTransactionStorage(t);n&&(e={getItem:function(t){var e=n.getStorage();return e&&e[t]?e[t]:null},setItem:function(t,e){var r=n.getStorage();if(!r)throw new it.c("Transaction has been cleared, failed to save idxState");r[t]=e,n.setStorage(r);},removeItem:function(t){var e=n.getStorage();e&&(delete e[t],n.setStorage(e));}});}return e?new Ge(e,k):null}},{key:"getTokenStorage",value:function(t){Je(t=this.getOptionsForSection("token",t));var e=this.getStorage(t),n=t.storageKey||m;return new Ge(e,n)}},{key:"getHttpCache",value:function(t){t=this.getOptionsForSection("cache",t);var e=this.getStorage(t),n=t.storageKey||b;return new Ge(e,n)}},{key:"getLegacyPKCEStorage",value:function(t){t=this.getOptionsForSection("legacy-pkce",t);var e=this.getStorage(t),n=t.storageKey||w;return new Ge(e,n)}},{key:"getLegacyOAuthParamsStorage",value:function(t){t=this.getOptionsForSection("legacy-oauth-params",t);var e=this.getStorage(t),n=t.storageKey||v;return new Ge(e,n)}}]),t}();function We(t){return t&&t.version}var Xe=function(){function t(e){a()(this,t),this.storageManager=e.storageManager,this.legacyWidgetSupport=!1!==e.legacyWidgetSupport,this.saveNonceCookie=!1!==e.saveNonceCookie,this.saveStateCookie=!1!==e.saveStateCookie,this.saveParamsCookie=!1!==e.saveParamsCookie,this.options=e;}return s()(t,[{key:"clear",value:function(){var t=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{},e=this.storageManager.getTransactionStorage();e.clearStorage();var n=this.storageManager.getIdxResponseStorage();null==n||n.clearStorage(),this.legacyWidgetSupport&&(t.oauth&&this.clearLegacyOAuthParams(),t.pkce&&this.clearLegacyPKCE());}},{key:"save",value:function(t){var e=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{},n=this.storageManager.getTransactionStorage(),r=n.getStorage();if(Zt(r)&&Object(C.y)("a saved auth transaction exists in storage. This may indicate another auth flow is already in progress."),n.setStorage(t),e.oauth&&(this.saveNonceCookie||this.saveStateCookie||this.saveParamsCookie)){var o=this.storageManager.getStorage({storageType:"cookie"});if(this.saveParamsCookie){var i=t.responseType,a=t.state,u=t.nonce,s=t.scopes,c=t.clientId,f=t.urls,l=t.ignoreSignature,h={responseType:i,state:a,nonce:u,scopes:s,clientId:c,urls:f,ignoreSignature:l};o.setItem(v,JSON.stringify(h),null);}this.saveNonceCookie&&t.nonce&&o.setItem(g,t.nonce,null),this.saveStateCookie&&t.state&&o.setItem(y,t.state,null);}}},{key:"exists",value:function(){var t=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{};try{var e=this.load(t);return !!e}catch(t){return !1}}},{key:"load",value:function(){var t=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{},e=this.storageManager.getTransactionStorage(),n=e.getStorage();if(Zt(n))return n;if(!this.legacyWidgetSupport)return null;if(t.oauth)try{var r=this.loadLegacyOAuthParams();Object.assign(n,r);}finally{this.clearLegacyOAuthParams();}if(t.pkce)try{var o=this.loadLegacyPKCE();Object.assign(n,o);}finally{this.clearLegacyPKCE();}return Zt(n)?n:null}},{key:"clearLegacyPKCE",value:function(){this.storageManager.storageUtil.testStorageType("localStorage")&&this.storageManager.getLegacyPKCEStorage({storageType:"localStorage"}).clearStorage(),this.storageManager.storageUtil.testStorageType("sessionStorage")&&this.storageManager.getLegacyPKCEStorage({storageType:"sessionStorage"}).clearStorage();}},{key:"loadLegacyPKCE",value:function(){var t;if(this.storageManager.storageUtil.testStorageType("localStorage")&&(t=this.storageManager.getLegacyPKCEStorage({storageType:"localStorage"}).getStorage())&&t.codeVerifier)return t;if(this.storageManager.storageUtil.testStorageType("sessionStorage")&&(t=this.storageManager.getLegacyPKCEStorage({storageType:"sessionStorage"}).getStorage())&&t.codeVerifier)return t;throw new it.c("Could not load PKCE codeVerifier from storage. This may indicate the auth flow has already completed or multiple auth flows are executing concurrently.",null)}},{key:"clearLegacyOAuthParams",value:function(){this.storageManager.storageUtil.testStorageType("sessionStorage")&&this.storageManager.getLegacyOAuthParamsStorage({storageType:"sessionStorage"}).clearStorage(),this.storageManager.storageUtil.testStorageType("cookie")&&this.storageManager.getLegacyOAuthParamsStorage({storageType:"cookie"}).clearStorage();}},{key:"loadLegacyOAuthParams",value:function(){var t;if(this.storageManager.storageUtil.testStorageType("sessionStorage")&&(t=this.storageManager.getLegacyOAuthParamsStorage({storageType:"sessionStorage"}).getStorage()),Jt(t))return t;if(this.storageManager.storageUtil.testStorageType("cookie")&&(t=this.storageManager.getLegacyOAuthParamsStorage({storageType:"cookie"}).getStorage()),Jt(t))return t;throw new it.c("Unable to retrieve OAuth redirect params from storage")}},{key:"saveIdxResponse",value:function(t){var e=this.storageManager.getIdxResponseStorage();e&&e.setStorage(t);}},{key:"loadIdxResponse",value:function(){var t=this.storageManager.getIdxResponseStorage();if(!t)return null;var e=t.getStorage();return We(e)?e:null}}]),t}(),Ze=n(209),Qe=new(n(218)),tn=function(){function t(e){a()(this,t),this.nodeCache=e;}return s()(t,[{key:"set",value:function(t,e,n){if(Date.parse(n)){var r=(Date.parse(n)-Date.now())/1e3;this.nodeCache.set(t,e,r);}else this.nodeCache.set(t,e);return this.get(t)}},{key:"get",value:function(t){return this.nodeCache.get(t)}},{key:"delete",value:function(t){return this.nodeCache.del(t)}}]),t}(),en=new(function(){function t(e){a()(this,t),this.nodeCache=e,this.storage=new tn(e);}return s()(t,[{key:"testStorageType",value:function(t){var e=!1;switch(t){case"memory":e=!0;}return e}},{key:"getStorageByType",value:function(t){var e=null;switch(t){case"memory":e=this.getStorage();break;default:throw new it.c("Unrecognized storage option: ".concat(t))}return e}},{key:"findStorageType",value:function(){return "memory"}},{key:"getHttpCache",value:function(){return null}},{key:"getStorage",value:function(){var t=this;return {getItem:this.nodeCache.get,setItem:function(e,n){t.nodeCache.set(e,n,"2200-01-01T00:00:00.000Z");}}}}]),t}())(Qe),nn={token:{storageTypes:["localStorage","sessionStorage","cookie"],useMultipleCookies:!0},cache:{storageTypes:["localStorage","sessionStorage","cookie"]},transaction:{storageTypes:["sessionStorage","localStorage","cookie"]}},rn={token:{storageTypes:["memory"]},cache:{storageTypes:["memory"]},transaction:{storageTypes:["memory"]}};function on(){var t=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{},e=arguments.length>1?arguments[1]:void 0,n=t.cookies||{};return void 0===n.secure&&(n.secure=e),void 0===n.sameSite&&(n.sameSite=n.secure?"none":"lax"),n.secure&&!e&&(Object(C.y)('The current page is not being served with the HTTPS protocol.\nFor security reasons, we strongly recommend using HTTPS.\nIf you cannot use HTTPS, set "cookies.secure" option to false.'),n.secure=!1),"none"!==n.sameSite||n.secure||(n.sameSite="lax"),n}function an(){var t=Object(dt.isBrowser)()?Ee:en,e=Object(dt.isBrowser)()?nn:rn;return {devMode:!1,httpRequestClient:Ze.a,storageUtil:t,storageManager:e}}function un(t,e){return Object.assign({},t,Object(C.t)(e),{storageManager:Object.assign({},t.storageManager,e.storageManager)})}var sn=n(31),cn=n.n(sn),fn=function(t,e,n,r){return new(n||(n=Promise))((function(o,i){function a(t){try{s(r.next(t));}catch(t){i(t);}}function u(t){try{s(r.throw(t));}catch(t){i(t);}}function s(t){var e;t.done?o(t.value):(e=t.value,e instanceof n?e:new n((function(t){t(e);}))).then(a,u);}s((r=r.apply(t,e||[])).next());}))};function ln(t){if(t.transactionManager.exists()){var e=t.transactionManager.load();if(dn(t,e)&&e.interactionHandle)return !0}return !1}function hn(t){return fn(this,void 0,void 0,f.a.mark((function e(){var n,r,o,i,a,u,s,c,l,h,p,d,v,y,g,m,b;return f.a.wrap((function(e){for(;;)switch(e.prev=e.next){case 0:if(!t.transactionManager.exists()){e.next=5;break}if(n=t.transactionManager.load(),!dn(t,n)){e.next=4;break}return e.abrupt("return",n);case 4:Object(C.y)("Saved transaction meta does not match the current configuration. This may indicate that two apps are sharing a storage key.");case 5:return e.next=7,t.token.prepareTokenParams();case 7:return r=e.sent,o=Tt(t,r),i=t.options.issuer,a=r.pkce,u=r.clientId,s=r.redirectUri,c=r.responseType,l=r.responseMode,h=r.scopes,p=r.state,d=r.nonce,v=r.ignoreSignature,y=r.codeVerifier,g=r.codeChallengeMethod,m=r.codeChallenge,b={issuer:i,pkce:a,clientId:u,redirectUri:s,responseType:c,responseMode:l,scopes:h,state:p,nonce:d,urls:o,ignoreSignature:v,codeVerifier:y,codeChallengeMethod:g,codeChallenge:m},e.abrupt("return",b);case 13:case"end":return e.stop()}}),e)})))}function pn(t,e){t.transactionManager.save(e);}function dn(t,e){return !["issuer","clientId","redirectUri"].find((function(n){return t.options[n]!==e[n]}))}var vn=function(t,e,n,r){return new(n||(n=Promise))((function(o,i){function a(t){try{s(r.next(t));}catch(t){i(t);}}function u(t){try{s(r.throw(t));}catch(t){i(t);}}function s(t){var e;t.done?o(t.value):(e=t.value,e instanceof n?e:new n((function(t){t(e);}))).then(a,u);}s((r=r.apply(t,e||[])).next());}))};function yn(t){return {meta:t,interactionHandle:t.interactionHandle,state:t.state}}function gn(t){var e=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{};return vn(this,void 0,void 0,f.a.mark((function n(){var r,o,i,a,u,s,c,l,h;return f.a.wrap((function(n){for(;;)switch(n.prev=n.next){case 0:return n.next=2,hn(t);case 2:if(!(r=n.sent).interactionHandle){n.next=5;break}return n.abrupt("return",yn(r));case 5:return o=r.codeChallenge,i=r.codeChallengeMethod,a=t.options,u=a.clientId,s=a.redirectUri,c=e.state||t.options.state||r.state,l=e.scopes||t.options.scopes||r.scopes,h=Ot(t),n.abrupt("return",cn.a.interact({clientId:u,baseUrl:h,scopes:l,state:c,redirectUri:s,codeChallenge:o,codeChallengeMethod:i}).then((function(e){var n=Object.assign(Object.assign({},r),{interactionHandle:e,state:c,scopes:l});return pn(t,n),yn(n)})));case 11:case"end":return n.stop()}}),n)})))}var mn=function(t,e,n,r){return new(n||(n=Promise))((function(o,i){function a(t){try{s(r.next(t));}catch(t){i(t);}}function u(t){try{s(r.throw(t));}catch(t){i(t);}}function s(t){var e;t.done?o(t.value):(e=t.value,e instanceof n?e:new n((function(t){t(e);}))).then(a,u);}s((r=r.apply(t,e||[])).next());}))};function bn(t,e){return mn(this,void 0,void 0,f.a.mark((function n(){var r,o,i;return f.a.wrap((function(n){for(;;)switch(n.prev=n.next){case 0:if(r=t.transactionManager.loadIdxResponse()){n.next=7;break}return o=j,i=St(t),n.next=6,cn.a.introspect(Object.assign({domain:i,version:o},e));case 6:r=n.sent;case 7:return n.abrupt("return",cn.a.makeIdxState(r));case 8:case"end":return n.stop()}}),n)})))}var wn=n(11),xn=n.n(wn);function kn(t,e){var n="undefined"!=typeof Symbol&&t[Symbol.iterator]||t["@@iterator"];if(!n){if(Array.isArray(t)||(n=function(t,e){if(!t)return;if("string"==typeof t)return On(t,e);var n=Object.prototype.toString.call(t).slice(8,-1);"Object"===n&&t.constructor&&(n=t.constructor.name);if("Map"===n||"Set"===n)return Array.from(t);if("Arguments"===n||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n))return On(t,e)}(t))||e&&t&&"number"==typeof t.length){n&&(t=n);var r=0,o=function(){};return {s:o,n:function(){return r>=t.length?{done:!0}:{done:!1,value:t[r++]}},e:function(t){throw t},f:o}}throw new TypeError("Invalid attempt to iterate non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.")}var i,a=!0,u=!1;return {s:function(){n=n.call(t);},n:function(){var t=n.next();return a=t.done,t},e:function(t){u=!0,i=t;},f:function(){try{a||null==n.return||n.return();}finally{if(u)throw i}}}}function On(t,e){(null==e||e>t.length)&&(e=t.length);for(var n=0,r=new Array(e);n<e;n++)r[n]=t[n];return r}var Sn=function(t,e,n,r){return new(n||(n=Promise))((function(o,i){function a(t){try{s(r.next(t));}catch(t){i(t);}}function u(t){try{s(r.throw(t));}catch(t){i(t);}}function s(t){var e;t.done?o(t.value):(e=t.value,e instanceof n?e:new n((function(t){t(e);}))).then(a,u);}s((r=r.apply(t,e||[])).next());}))},Tn={resend:"currentAuthenticatorEnrollment-resend"};function _n(t,e,n){var r,o,i=n.flow,a=n.flowMonitor,u=[],s=kn(t);try{for(s.s();!(o=s.n()).done;){var c=o.value;if(Object.keys(i).includes(c.name))if(r=new(0,i[c.name])(c,e),a.isRemediatorCandidate(r,t,e)){if(r.canRemediate())return r;u.push(r);}}}catch(t){s.e(t);}finally{s.f();}return u[0]}function En(t){var e=t.neededToProceed,n=t.interactionCode;return !e.length&&!n}function An(t,e){var n,r=[],o=t.rawIdxState,i=t.neededToProceed,a=null===(n=o.messages)||void 0===n?void 0:n.value.map((function(t){return t}));a&&(r=[].concat(xn()(r),xn()(a)));var u,s=kn(i);try{for(s.s();!(u=s.n()).done;){var c=u.value,f=e[c.name];if(f){var l=new f(c).getMessages();l&&(r=[].concat(xn()(r),xn()(l)));}}}catch(t){s.e(t);}finally{s.f();}return r}function Rn(t,e){var n=t.getNextStep(),r=function(t){return t.neededToProceed.some((function(t){return "skip"===t.name}))}(e),o=function(t){return Object.keys(t.actions).some((function(t){return t.includes("resend")}))}(e);return Object.assign(Object.assign(Object.assign({},n),r&&{canSkip:r}),o&&{canResend:o})}function jn(t,e,n){if(We(t)){var r=cn.a.makeIdxState(t),o=En(r),i=An(r,e);if(o)return {terminal:o,messages:i};var a=n&&Rn(n,r);return Object.assign({messages:i},a&&{nextStep:a})}throw t}function Pn(t){var e=Object.keys(t).find((function(t){return Tn[t]}));return Tn[e]}function Cn(t,e){var n=Object.keys(Tn).find((function(t){return Tn[t]===e}));return Object.keys(t).filter((function(t){return t!==n})).reduce((function(e,n){return e[n]=t[n],e}),{})}function In(t,e,n){return Sn(this,void 0,void 0,f.a.mark((function r(){var o,i,a,u,s,c,l,h,p,d,v,y,g,m,b,w,x;return f.a.wrap((function(r){for(;;)switch(r.prev=r.next){case 0:if(i=(o=t).neededToProceed,!o.interactionCode){r.next=3;break}return r.abrupt("return",{idxResponse:t});case 3:if(a=n.flow,u=n.flowMonitor,s=Pn(e),!(c=[].concat(xn()(n.actions||[]),xn()(s&&[s]||[])))){r.next=36;break}l=kn(c),r.prev=8,l.s();case 10:if((h=l.n()).done){r.next=28;break}if(p=h.value,d=Cn(e,p),"function"!=typeof t.actions[p]){r.next=26;break}return r.prev=14,r.next=17,t.actions[p]();case 17:t=r.sent,r.next=23;break;case 20:return r.prev=20,r.t0=r.catch(14),r.abrupt("return",jn(r.t0,a));case 23:if("cancel"!==p){r.next=25;break}return r.abrupt("return",{canceled:!0});case 25:return r.abrupt("return",In(t,d,n));case 26:r.next=10;break;case 28:r.next=33;break;case 30:r.prev=30,r.t1=r.catch(8),l.e(r.t1);case 33:return r.prev=33,l.f(),r.finish(33);case 36:if(v=_n(i,e,n)){r.next=39;break}throw new it.c("\n      No remediation can match current flow, check policy settings in your org.\n      Remediations: [".concat(i.reduce((function(t,e){return t?t+" ,"+e.name:e.name}),""),"]\n    "));case 39:if(!u.loopDetected(v)){r.next=41;break}throw new it.c("\n      Remediation run into loop, break!!! remediation: ".concat(v.getName(),"\n    "));case 41:if(v.canRemediate()){r.next=44;break}return y=Rn(v,t),r.abrupt("return",{idxResponse:t,nextStep:y});case 44:return g=v.getName(),m=v.getData(),r.prev=46,r.next=49,t.proceed(g,m);case 49:return t=r.sent,r.next=52,u.trackRemediations(g);case 52:if(!t.interactionCode){r.next=54;break}return r.abrupt("return",{idxResponse:t});case 54:if(b=En(t),w=An(t,a),!b){r.next=58;break}return r.abrupt("return",{terminal:b,messages:w});case 58:if(!w.length){r.next=61;break}return x=Rn(v,t),r.abrupt("return",{nextStep:x,messages:w});case 61:return e=v.getValuesAfterProceed(),r.abrupt("return",In(t,e,n));case 65:return r.prev=65,r.t2=r.catch(46),r.abrupt("return",jn(r.t2,a,v));case 68:case"end":return r.stop()}}),r,null,[[8,30,33,36],[14,20],[46,65]])})))}function Mn(t){return t.charAt(0).toUpperCase()+t.substring(1)}function Un(t){return t.value.find((function(t){return "authenticator"===t.name}))}var Ln=function(){function t(e){var n,r=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{};a()(this,t),r.authenticators=(null===(n=r.authenticators)||void 0===n?void 0:n.map((function(t){return "string"==typeof t?{type:t}:t})))||[],this.values=r,this.remediation=e;}return s()(t,[{key:"getName",value:function(){return this.remediation.name}},{key:"canRemediate",value:function(){var t=this;return !!this.map&&!this.remediation.value.reduce((function(t,e){return e.required&&t.push(e.name),t}),[]).find((function(e){return !t.hasData(e)}))}},{key:"getData",value:function(t){var e=this;if(!t)return this.remediation.value.map((function(t){return t.name})).reduce((function(t,n){return t[n]=e.getData(n),t}),{});if("function"==typeof this["map".concat(Mn(t))])return this["map".concat(Mn(t))](this.remediation.value.find((function(e){return e.name===t})));if(!this.map)return this.values[t];var n=this.map[t];if(!n)return this.values[t];for(var r=0;r<n.length;r++){var o=this.values[n[r]];if(o)return o}}},{key:"hasData",value:function(t){var e=this.getData(t);return "object"===Yt()(e)?!!Object.keys(e).find((function(t){return !!e[t]})):!!e}},{key:"getNextStep",value:function(){var t=this.getName(),e=this.getRelatesToType(),n=this.getInputs();return Object.assign({name:t,inputs:n},e&&{type:e})}},{key:"getInputs",value:function(){var t=this;return this.map?Object.keys(this.map).reduce((function(e,n){var r,o=t.remediation.value.find((function(t){return t.name===n}));if(!o)return e;var i=t.map[n],a=o.type;if("function"==typeof t["getInput".concat(Mn(n))])r=t["getInput".concat(Mn(n))](o);else if("object"!==a){var u;(u=1===i.length?i[0]:i.find((function(e){return Object.keys(t.values).includes(e)})))&&(r=Object.assign(Object.assign({},o),{name:u}));}if(!r)throw new it.c("Missing custom getInput".concat(Mn(n)," method in Remediator: ").concat(t.getName()));return Array.isArray(r)?r.forEach((function(t){return e.push(t)})):e.push(r),e}),[]):[]}},{key:"getMessages",value:function(){var t,e;if(this.remediation.value)return null===(e=null===(t=this.remediation.value[0])||void 0===t?void 0:t.form)||void 0===e?void 0:e.value.reduce((function(t,e){return e.messages&&(t=[].concat(xn()(t),xn()(e.messages.value))),t}),[])}},{key:"getValuesAfterProceed",value:function(){var t,e=this.getRelatesToType(),n=null===(t=this.values.authenticators)||void 0===t?void 0:t.filter((function(t){return t.type!==e}));return Object.assign(Object.assign({},this.values),{authenticators:n})}},{key:"getRelatesToType",value:function(){var t;return null===(t=this.remediation.relatesTo)||void 0===t?void 0:t.value.type}}]),t}(),Fn=n(6),Nn=n.n(Fn),Dn=n(7),Bn=n.n(Dn),Hn=n(3),qn=n.n(Hn);function Kn(t){var e=function(){if("undefined"==typeof Reflect||!Reflect.construct)return !1;if(Reflect.construct.sham)return !1;if("function"==typeof Proxy)return !0;try{return Boolean.prototype.valueOf.call(Reflect.construct(Boolean,[],(function(){}))),!0}catch(t){return !1}}();return function(){var n,r=qn()(t);if(e){var o=qn()(this).constructor;n=Reflect.construct(r,arguments,o);}else n=r.apply(this,arguments);return Bn()(this,n)}}var Vn=function(t){Nn()(n,t);var e=Kn(n);function n(){var t;return a()(this,n),(t=e.apply(this,arguments)).map={credentials:[]},t}return s()(n,[{key:"canRemediate",value:function(){var t=this.getRelatesToType();return !(!this.values.verificationCode||!["email","phone"].includes(t))||!(!this.values.password||"password"!==t)}},{key:"mapCredentials",value:function(){return {passcode:this.values.verificationCode||this.values.password}}},{key:"getInputCredentials",value:function(t){var e="password"===this.getRelatesToType()?"password":"verificationCode";return Object.assign(Object.assign({},t.form.value[0]),{name:e,type:"string",required:t.required})}}]),n}(Ln);function zn(t){var e=function(){if("undefined"==typeof Reflect||!Reflect.construct)return !1;if(Reflect.construct.sham)return !1;if("function"==typeof Proxy)return !0;try{return Boolean.prototype.valueOf.call(Reflect.construct(Boolean,[],(function(){}))),!0}catch(t){return !1}}();return function(){var n,r=qn()(t);if(e){var o=qn()(this).constructor;n=Reflect.construct(r,arguments,o);}else n=r.apply(this,arguments);return Bn()(this,n)}}Vn.remediationName="challenge-authenticator";var Yn=function(t){Nn()(n,t);var e=zn(n);function n(){return a()(this,n),e.apply(this,arguments)}return n}(Vn);function Gn(t){var e=function(){if("undefined"==typeof Reflect||!Reflect.construct)return !1;if(Reflect.construct.sham)return !1;if("function"==typeof Proxy)return !0;try{return Boolean.prototype.valueOf.call(Reflect.construct(Boolean,[],(function(){}))),!0}catch(t){return !1}}();return function(){var n,r=qn()(t);if(e){var o=qn()(this).constructor;n=Reflect.construct(r,arguments,o);}else n=r.apply(this,arguments);return Bn()(this,n)}}Yn.remediationName="enroll-authenticator";var Jn=function(t){Nn()(n,t);var e=Gn(n);function n(){return a()(this,n),e.apply(this,arguments)}return n}(Vn);function $n(t){var e=function(){if("undefined"==typeof Reflect||!Reflect.construct)return !1;if(Reflect.construct.sham)return !1;if("function"==typeof Proxy)return !0;try{return Boolean.prototype.valueOf.call(Reflect.construct(Boolean,[],(function(){}))),!0}catch(t){return !1}}();return function(){var n,r=qn()(t);if(e){var o=qn()(this).constructor;n=Reflect.construct(r,arguments,o);}else n=r.apply(this,arguments);return Bn()(this,n)}}Jn.remediationName="challenge-authenticator";var Wn=function(t){Nn()(n,t);var e=$n(n);function n(){return a()(this,n),e.apply(this,arguments)}return n}(Vn);Wn.remediationName="reset-authenticator";var Xn=n(210),Zn=n.n(Xn);function Qn(t){var e=function(){if("undefined"==typeof Reflect||!Reflect.construct)return !1;if(Reflect.construct.sham)return !1;if("function"==typeof Proxy)return !0;try{return Boolean.prototype.valueOf.call(Reflect.construct(Boolean,[],(function(){}))),!0}catch(t){return !1}}();return function(){var n,r=qn()(t);if(e){var o=qn()(this).constructor;n=Reflect.construct(r,arguments,o);}else n=r.apply(this,arguments);return Bn()(this,n)}}var tr=function(t){Nn()(n,t);var e=Qn(n);function n(){var t;return a()(this,n),(t=e.apply(this,arguments)).map={userProfile:[]},t}return s()(n,[{key:"mapUserProfile",value:function(t){var e=this;return t.form.value.map((function(t){return t.name})).reduce((function(t,n){return e.values[n]?Object.assign(Object.assign({},t),Zn()({},n,e.values[n])):t}),{})}},{key:"getInputUserProfile",value:function(t){return xn()(t.form.value)}},{key:"getErrorMessages",value:function(t){return t.value[0].form.value.reduce((function(t,e){return e.messages&&t.push(e.messages.value[0].message),t}),[])}}]),n}(Ln);tr.remediationName="enroll-profile";var er=n(18),nr=n.n(er);function rr(t){var e=function(){if("undefined"==typeof Reflect||!Reflect.construct)return !1;if(Reflect.construct.sham)return !1;if("function"==typeof Proxy)return !0;try{return Boolean.prototype.valueOf.call(Reflect.construct(Boolean,[],(function(){}))),!0}catch(t){return !1}}();return function(){var n,r=qn()(t);if(e){var o=qn()(this).constructor;n=Reflect.construct(r,arguments,o);}else n=r.apply(this,arguments);return Bn()(this,n)}}var or=function(t){Nn()(n,t);var e=rr(n);function n(t,r){var o;a()(this,n),(o=e.call(this,t,r)).map={identifier:["username"],credentials:[]};var i=o.values,u=i.password,s=i.authenticators;return u&&!s.some((function(t){return "password"===t.type}))&&(o.values=Object.assign(Object.assign({},o.values),{authenticators:[{type:"password"}].concat(xn()(s))})),o}return s()(n,[{key:"canRemediate",value:function(){return !!this.getData().identifier}},{key:"mapCredentials",value:function(){return {passcode:this.values.password}}},{key:"getInputCredentials",value:function(t){return Object.assign(Object.assign({},t.form.value[0]),{name:"password",required:t.required})}},{key:"getValuesAfterProceed",value:function(){var t;if(this.remediation.value.some((function(t){return "credentials"===t.name}))){var e=null===(t=this.values.authenticators)||void 0===t?void 0:t.filter((function(t){return "password"!==t.type}));return Object.assign(Object.assign({},this.values),{authenticators:e})}return nr()(qn()(n.prototype),"getValuesAfterProceed",this).call(this)}}]),n}(Ln);function ir(t){var e=function(){if("undefined"==typeof Reflect||!Reflect.construct)return !1;if(Reflect.construct.sham)return !1;if("function"==typeof Proxy)return !0;try{return Boolean.prototype.valueOf.call(Reflect.construct(Boolean,[],(function(){}))),!0}catch(t){return !1}}();return function(){var n,r=qn()(t);if(e){var o=qn()(this).constructor;n=Reflect.construct(r,arguments,o);}else n=r.apply(this,arguments);return Bn()(this,n)}}or.remediationName="identify";var ar=function(t){Nn()(n,t);var e=ir(n);function n(){var t;return a()(this,n),(t=e.apply(this,arguments)).map={credentials:[]},t}return s()(n,[{key:"mapCredentials",value:function(){return {passcode:this.values.newPassword}}},{key:"getInputCredentials",value:function(t){var e="password"===this.getRelatesToType()?"newPassword":"verificationCode";return Object.assign(Object.assign({},t.form.value[0]),{name:e})}}]),n}(Ln);function ur(t){var e=function(){if("undefined"==typeof Reflect||!Reflect.construct)return !1;if(Reflect.construct.sham)return !1;if("function"==typeof Proxy)return !0;try{return Boolean.prototype.valueOf.call(Reflect.construct(Boolean,[],(function(){}))),!0}catch(t){return !1}}();return function(){var n,r=qn()(t);if(e){var o=qn()(this).constructor;n=Reflect.construct(r,arguments,o);}else n=r.apply(this,arguments);return Bn()(this,n)}}ar.remediationName="reenroll-authenticator";var sr=function(t){Nn()(n,t);var e=ur(n);function n(){return a()(this,n),e.apply(this,arguments)}return s()(n,[{key:"canRemediate",value:function(){return !1}},{key:"getNextStep",value:function(){var t=this.remediation;return {name:t.name,type:t.type,idp:t.idp,href:t.href}}}]),n}(Ln);function cr(t){var e=function(){if("undefined"==typeof Reflect||!Reflect.construct)return !1;if(Reflect.construct.sham)return !1;if("function"==typeof Proxy)return !0;try{return Boolean.prototype.valueOf.call(Reflect.construct(Boolean,[],(function(){}))),!0}catch(t){return !1}}();return function(){var n,r=qn()(t);if(e){var o=qn()(this).constructor;n=Reflect.construct(r,arguments,o);}else n=r.apply(this,arguments);return Bn()(this,n)}}function fr(t,e){var n="undefined"!=typeof Symbol&&t[Symbol.iterator]||t["@@iterator"];if(!n){if(Array.isArray(t)||(n=function(t,e){if(!t)return;if("string"==typeof t)return lr(t,e);var n=Object.prototype.toString.call(t).slice(8,-1);"Object"===n&&t.constructor&&(n=t.constructor.name);if("Map"===n||"Set"===n)return Array.from(t);if("Arguments"===n||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n))return lr(t,e)}(t))||e&&t&&"number"==typeof t.length){n&&(t=n);var r=0,o=function(){};return {s:o,n:function(){return r>=t.length?{done:!0}:{done:!1,value:t[r++]}},e:function(t){throw t},f:o}}throw new TypeError("Invalid attempt to iterate non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.")}var i,a=!0,u=!1;return {s:function(){n=n.call(t);},n:function(){var t=n.next();return a=t.done,t},e:function(t){u=!0,i=t;},f:function(){try{a||null==n.return||n.return();}finally{if(u)throw i}}}}function lr(t,e){(null==e||e>t.length)&&(e=t.length);for(var n=0,r=new Array(e);n<e;n++)r[n]=t[n];return r}function hr(t,e){var n,r,o=fr(t);try{var i=function(){var t=r.value;if(n=e.find((function(e){return e.relatesTo.type===t.type})))return "break"};for(o.s();!(r=o.n()).done;){if("break"===i())break}}catch(t){o.e(t);}finally{o.f();}return n}sr.remediationName="redirect-idp";var pr=function(t){Nn()(n,t);var e=cr(n);function n(t){var r,o=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{};a()(this,n),(r=e.call(this,t,o)).map={authenticator:[]};var i=r.values,u=i.authenticator,s=i.authenticators,c=null==s?void 0:s.some((function(t){return t.type===u}));return u&&!c&&(r.values.authenticators=[].concat(xn()(s||[]),[{type:u}])),r}return s()(n,[{key:"canRemediate",value:function(){var t=this.values.authenticators,e=Un(this.remediation).options;return !(!t||!t.length)&&!!hr(t,e)}},{key:"getNextStep",value:function(){var t=nr()(qn()(n.prototype),"getNextStep",this).call(this),e=Un(this.remediation).options.map((function(t){return {label:t.label,value:t.relatesTo.type}}));return Object.assign(Object.assign({},t),{options:e})}},{key:"mapAuthenticator",value:function(t){var e=hr(this.values.authenticators,t.options);return {id:null==e?void 0:e.value.form.value.find((function(t){return "id"===t.name})).value}}},{key:"getInputAuthenticator",value:function(){return {name:"authenticator",type:"string"}}}]),n}(Ln);function dr(t){var e=function(){if("undefined"==typeof Reflect||!Reflect.construct)return !1;if(Reflect.construct.sham)return !1;if("function"==typeof Proxy)return !0;try{return Boolean.prototype.valueOf.call(Reflect.construct(Boolean,[],(function(){}))),!0}catch(t){return !1}}();return function(){var n,r=qn()(t);if(e){var o=qn()(this).constructor;n=Reflect.construct(r,arguments,o);}else n=r.apply(this,arguments);return Bn()(this,n)}}var vr=function(t){Nn()(n,t);var e=dr(n);function n(){return a()(this,n),e.apply(this,arguments)}return n}(pr);function yr(t){var e=function(){if("undefined"==typeof Reflect||!Reflect.construct)return !1;if(Reflect.construct.sham)return !1;if("function"==typeof Proxy)return !0;try{return Boolean.prototype.valueOf.call(Reflect.construct(Boolean,[],(function(){}))),!0}catch(t){return !1}}();return function(){var n,r=qn()(t);if(e){var o=qn()(this).constructor;n=Reflect.construct(r,arguments,o);}else n=r.apply(this,arguments);return Bn()(this,n)}}vr.remediationName="select-authenticator-authenticate";var gr=function(t){Nn()(n,t);var e=yr(n);function n(){return a()(this,n),e.apply(this,arguments)}return n}(pr);function mr(t){var e=function(){if("undefined"==typeof Reflect||!Reflect.construct)return !1;if(Reflect.construct.sham)return !1;if("function"==typeof Proxy)return !0;try{return Boolean.prototype.valueOf.call(Reflect.construct(Boolean,[],(function(){}))),!0}catch(t){return !1}}();return function(){var n,r=qn()(t);if(e){var o=qn()(this).constructor;n=Reflect.construct(r,arguments,o);}else n=r.apply(this,arguments);return Bn()(this,n)}}gr.remediationName="select-authenticator-enroll";var br=function(t){Nn()(n,t);var e=mr(n);function n(){return a()(this,n),e.apply(this,arguments)}return s()(n,[{key:"canRemediate",value:function(){return !0}}]),n}(Ln);function wr(t){var e=function(){if("undefined"==typeof Reflect||!Reflect.construct)return !1;if(Reflect.construct.sham)return !1;if("function"==typeof Proxy)return !0;try{return Boolean.prototype.valueOf.call(Reflect.construct(Boolean,[],(function(){}))),!0}catch(t){return !1}}();return function(){var n,r=qn()(t);if(e){var o=qn()(this).constructor;n=Reflect.construct(r,arguments,o);}else n=r.apply(this,arguments);return Bn()(this,n)}}br.remediationName="select-enroll-profile";var xr=function(t){Nn()(n,t);var e=wr(n);function n(t){var r,o,i=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{};a()(this,n),(r=e.call(this,t,i)).map={authenticator:[]};var u=r.values.authenticators,s=r.getRelatesToType(),c=null===(o=u)||void 0===o?void 0:o.find((function(t){return t.type===s}));return r.values.authenticators=c?u.map((function(t){return s===t.type?r.mapAuthenticatorFromValues(t):t})):[].concat(xn()(u),[r.mapAuthenticatorFromValues()]),r}return s()(n,[{key:"getNextStep",value:function(){var t=nr()(qn()(n.prototype),"getNextStep",this).call(this),e=this.getMethodTypes();return Object.assign(Object.assign({},t),e&&{options:e})}},{key:"getAuthenticatorFromValues",value:function(){if(!this.values.authenticators)return null;var t=this.getRelatesToType();return this.values.authenticators.find((function(e){return e.type===t}))}},{key:"mapAuthenticatorFromValues",value:function(t){var e=this.getRelatesToType(),n=this.values.methodType;return Object.assign(Object.assign({type:e},t&&t),n&&{methodType:n})}},{key:"getAuthenticatorFromRemediation",value:function(){return this.remediation.value.find((function(t){return "authenticator"===t.name}))}},{key:"getMethodTypes",value:function(){var t;return null===(t=this.getAuthenticatorFromRemediation().form.value.find((function(t){return "methodType"===t.name})))||void 0===t?void 0:t.options}}]),n}(Ln);function kr(t){var e=function(){if("undefined"==typeof Reflect||!Reflect.construct)return !1;if(Reflect.construct.sham)return !1;if("function"==typeof Proxy)return !0;try{return Boolean.prototype.valueOf.call(Reflect.construct(Boolean,[],(function(){}))),!0}catch(t){return !1}}();return function(){var n,r=qn()(t);if(e){var o=qn()(this).constructor;n=Reflect.construct(r,arguments,o);}else n=r.apply(this,arguments);return Bn()(this,n)}}var Or=function(t){Nn()(n,t);var e=kr(n);function n(){return a()(this,n),e.apply(this,arguments)}return s()(n,[{key:"canRemediate",value:function(){var t=this.getAuthenticatorFromValues();return !(!t||!t.methodType)}},{key:"mapAuthenticator",value:function(){var t=this.getAuthenticatorFromRemediation(),e=this.getAuthenticatorFromValues();return {id:t.form.value.find((function(t){return "id"===t.name})).value,enrollmentId:t.form.value.find((function(t){return "enrollmentId"===t.name})).value,methodType:e.methodType}}},{key:"getInputAuthenticator",value:function(){var t=this.getAuthenticatorFromRemediation(),e=t.form.value.find((function(t){return "methodType"===t.name}));return e&&e.options?{name:"methodType",type:"string",required:!0}:xn()(t.form.value)}}]),n}(xr);function Sr(t){var e=function(){if("undefined"==typeof Reflect||!Reflect.construct)return !1;if(Reflect.construct.sham)return !1;if("function"==typeof Proxy)return !0;try{return Boolean.prototype.valueOf.call(Reflect.construct(Boolean,[],(function(){}))),!0}catch(t){return !1}}();return function(){var n,r=qn()(t);if(e){var o=qn()(this).constructor;n=Reflect.construct(r,arguments,o);}else n=r.apply(this,arguments);return Bn()(this,n)}}Or.remediationName="authenticator-verification-data";var Tr=function(t){Nn()(n,t);var e=Sr(n);function n(){return a()(this,n),e.apply(this,arguments)}return s()(n,[{key:"canRemediate",value:function(){var t=this.getAuthenticatorFromValues();return !!(t&&t.methodType&&t.phoneNumber)}},{key:"mapAuthenticator",value:function(){var t=this.getAuthenticatorFromValues();return {id:Un(this.remediation).form.value.find((function(t){return "id"===t.name})).value,methodType:t.methodType,phoneNumber:t.phoneNumber}}},{key:"getInputAuthenticator",value:function(){return [{name:"methodType",type:"string",required:!0},{name:"phoneNumber",type:"string",required:!0}]}},{key:"mapAuthenticatorFromValues",value:function(t){t=nr()(qn()(n.prototype),"mapAuthenticatorFromValues",this).call(this,t);var e=this.values.phoneNumber;return Object.assign(Object.assign({},t),e&&{phoneNumber:e})}}]),n}(xr);function _r(t){var e=function(){if("undefined"==typeof Reflect||!Reflect.construct)return !1;if(Reflect.construct.sham)return !1;if("function"==typeof Proxy)return !0;try{return Boolean.prototype.valueOf.call(Reflect.construct(Boolean,[],(function(){}))),!0}catch(t){return !1}}();return function(){var n,r=qn()(t);if(e){var o=qn()(this).constructor;n=Reflect.construct(r,arguments,o);}else n=r.apply(this,arguments);return Bn()(this,n)}}Tr.remediationName="authenticator-enrollment-data";var Er=function(t){Nn()(n,t);var e=_r(n);function n(){return a()(this,n),e.apply(this,arguments)}return s()(n,[{key:"canRemediate",value:function(){return !!this.values.skip}}]),n}(Ln);function Ar(t,e){var n="undefined"!=typeof Symbol&&t[Symbol.iterator]||t["@@iterator"];if(!n){if(Array.isArray(t)||(n=function(t,e){if(!t)return;if("string"==typeof t)return Rr(t,e);var n=Object.prototype.toString.call(t).slice(8,-1);"Object"===n&&t.constructor&&(n=t.constructor.name);if("Map"===n||"Set"===n)return Array.from(t);if("Arguments"===n||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n))return Rr(t,e)}(t))||e&&t&&"number"==typeof t.length){n&&(t=n);var r=0,o=function(){};return {s:o,n:function(){return r>=t.length?{done:!0}:{done:!1,value:t[r++]}},e:function(t){throw t},f:o}}throw new TypeError("Invalid attempt to iterate non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.")}var i,a=!0,u=!1;return {s:function(){n=n.call(t);},n:function(){var t=n.next();return a=t.done,t},e:function(t){u=!0,i=t;},f:function(){try{a||null==n.return||n.return();}finally{if(u)throw i}}}}function Rr(t,e){(null==e||e>t.length)&&(e=t.length);for(var n=0,r=new Array(e);n<e;n++)r[n]=t[n];return r}Er.remediationName="skip";var jr=function(t,e,n,r){return new(n||(n=Promise))((function(o,i){function a(t){try{s(r.next(t));}catch(t){i(t);}}function u(t){try{s(r.throw(t));}catch(t){i(t);}}function s(t){var e;t.done?o(t.value):(e=t.value,e instanceof n?e:new n((function(t){t(e);}))).then(a,u);}s((r=r.apply(t,e||[])).next());}))};function Pr(t){var e=[],n=t.actions,r=t.neededToProceed;return n["currentAuthenticator-recover"]&&e.push(Vt.PASSWORD_RECOVERY),r.some((function(t){return "select-enroll-profile"===t.name}))&&e.push(Vt.REGISTRATION),r.some((function(t){return "redirect-idp"===t.name}))&&e.push(Vt.SOCIAL_IDP),e}function Cr(t){var e,n=[],r=Object.values(o).reduce((function(t,e){return e.remediationName&&(t[e.remediationName]=e),t}),{}),i=Ar(t);try{for(i.s();!(e=i.n()).done;){var a=e.value,u=r[a.name];if(u){var s=new u(a);n.push(s.getNextStep());}}}catch(t){i.e(t);}finally{i.f();}return n}function Ir(t,e){return jr(this,void 0,void 0,f.a.mark((function n(){var r,o,i,a,u,s,c,l,h,p,d,v,y,g,m,b,w,x,k,O,S,T,_,E,A,R;return f.a.wrap((function(n){for(;;)switch(n.prev=n.next){case 0:return l=Kt.PENDING,h=!1,n.prev=2,n.next=5,gn(t,e);case 5:return p=n.sent,d=p.interactionHandle,v=p.meta,n.next=10,bn(t,{interactionHandle:d});case 10:if(y=n.sent,e.flow||e.actions){n.next=17;break}u=v,s=Pr(y),c=Cr(y.neededToProceed),n.next=46;break;case 17:return g=Object.assign(Object.assign({},e),{stateHandle:y.rawIdxState.stateHandle}),n.next=20,In(y,g,e);case 20:if(m=n.sent,b=m.idxResponse,w=m.nextStep,x=m.terminal,k=m.canceled,O=m.messages,i=O,(o=w)&&b&&t.transactionManager.saveIdxResponse(b.rawIdxState),x&&(l=Kt.TERMINAL,h=!0),!k){n.next=35;break}l=Kt.CANCELED,h=!0,n.next=46;break;case 35:if(!(null==b?void 0:b.interactionCode)){n.next=46;break}return n.next=38,e.flowMonitor.isFinished();case 38:if(n.sent){n.next=40;break}throw new it.c("Current flow is not supported, check policy settings in your org.");case 40:return S=v.clientId,T=v.codeVerifier,_=v.ignoreSignature,E=v.redirectUri,A=v.urls,R=v.scopes,n.next=43,t.token.exchangeCodeForTokens({interactionCode:b.interactionCode,clientId:S,codeVerifier:T,ignoreSignature:_,redirectUri:E,scopes:R},A);case 43:r=n.sent,l=Kt.SUCCESS,h=!0;case 46:n.next=53;break;case 48:n.prev=48,n.t0=n.catch(2),a=n.t0,l=Kt.FAILURE,h=!0;case 53:return h&&t.transactionManager.clear(),n.abrupt("return",Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign({status:l},u&&{meta:u}),s&&{enabledFeatures:s}),c&&{availableSteps:c}),r&&{tokens:r.tokens}),o&&{nextStep:o}),i&&{messages:i}),a&&{error:a}));case 55:case"end":return n.stop()}}),n,null,[[2,48]])})))}var Mr=function(t,e,n,r){return new(n||(n=Promise))((function(o,i){function a(t){try{s(r.next(t));}catch(t){i(t);}}function u(t){try{s(r.throw(t));}catch(t){i(t);}}function s(t){var e;t.done?o(t.value):(e=t.value,e instanceof n?e:new n((function(t){t(e);}))).then(a,u);}s((r=r.apply(t,e||[])).next());}))},Ur=function(){function t(e){a()(this,t),this.authClient=e;}return s()(t,[{key:"loopDetected",value:function(t){return this.previousRemediator&&this.previousRemediator.getName()===t.getName()||(this.previousRemediator=t,!1)}},{key:"isRemediatorCandidate",value:function(t,e,n){var r=t.getName();return !(!n.skip&&"skip"===r)&&(!n.skip||"skip"===r)}},{key:"trackRemediations",value:function(t){return Mr(this,void 0,void 0,f.a.mark((function e(){var n,r;return f.a.wrap((function(e){for(;;)switch(e.prev=e.next){case 0:return e.next=2,hn(this.authClient);case 2:n=e.sent,r=n.remediations||[],n=Object.assign(Object.assign({},n),{remediations:[].concat(xn()(r),[t])}),pn(this.authClient,n);case 6:case"end":return e.stop()}}),e,this)})))}},{key:"isFinished",value:function(){return Promise.resolve(!0)}}]),t}();function Lr(t){var e=function(){if("undefined"==typeof Reflect||!Reflect.construct)return !1;if(Reflect.construct.sham)return !1;if("function"==typeof Proxy)return !0;try{return Boolean.prototype.valueOf.call(Reflect.construct(Boolean,[],(function(){}))),!0}catch(t){return !1}}();return function(){var n,r=qn()(t);if(e){var o=qn()(this).constructor;n=Reflect.construct(r,arguments,o);}else n=r.apply(this,arguments);return Bn()(this,n)}}var Fr=function(t){Nn()(n,t);var e=Lr(n);function n(){return a()(this,n),e.apply(this,arguments)}return s()(n,[{key:"isRemediatorCandidate",value:function(t,e,r){var o,i=null===(o=this.previousRemediator)||void 0===o?void 0:o.getName();return ("select-authenticator-enroll"!==t.getName()||!["select-authenticator-enroll","authenticator-enrollment-data"].includes(i))&&nr()(qn()(n.prototype),"isRemediatorCandidate",this).call(this,t,e,r)}}]),n}(Ur);function Nr(t){var e=function(){if("undefined"==typeof Reflect||!Reflect.construct)return !1;if(Reflect.construct.sham)return !1;if("function"==typeof Proxy)return !0;try{return Boolean.prototype.valueOf.call(Reflect.construct(Boolean,[],(function(){}))),!0}catch(t){return !1}}();return function(){var n,r=qn()(t);if(e){var o=qn()(this).constructor;n=Reflect.construct(r,arguments,o);}else n=r.apply(this,arguments);return Bn()(this,n)}}var Dr=function(t){Nn()(n,t);var e=Nr(n);function n(){return a()(this,n),e.apply(this,arguments)}return s()(n,[{key:"isRemediatorCandidate",value:function(t,e,r){var o,i=null===(o=this.previousRemediator)||void 0===o?void 0:o.getName(),a=t.getName();return ("select-authenticator-authenticate"!==a||!["select-authenticator-authenticate"].includes(i))&&(("select-authenticator-authenticate"!==a||!e.some((function(t){return "challenge-authenticator"===t.name})))&&(("select-authenticator-enroll"!==a||!["select-authenticator-enroll","authenticator-enrollment-data"].includes(i))&&nr()(qn()(n.prototype),"isRemediatorCandidate",this).call(this,t,e,r)))}}]),n}(Ur);function Br(t){var e=function(){if("undefined"==typeof Reflect||!Reflect.construct)return !1;if(Reflect.construct.sham)return !1;if("function"==typeof Proxy)return !0;try{return Boolean.prototype.valueOf.call(Reflect.construct(Boolean,[],(function(){}))),!0}catch(t){return !1}}();return function(){var n,r=qn()(t);if(e){var o=qn()(this).constructor;n=Reflect.construct(r,arguments,o);}else n=r.apply(this,arguments);return Bn()(this,n)}}var Hr=function(t,e,n,r){return new(n||(n=Promise))((function(o,i){function a(t){try{s(r.next(t));}catch(t){i(t);}}function u(t){try{s(r.throw(t));}catch(t){i(t);}}function s(t){var e;t.done?o(t.value):(e=t.value,e instanceof n?e:new n((function(t){t(e);}))).then(a,u);}s((r=r.apply(t,e||[])).next());}))},qr=function(t){Nn()(n,t);var e=Br(n);function n(){return a()(this,n),e.apply(this,arguments)}return s()(n,[{key:"isRemediatorCandidate",value:function(t,e,r){var o,i=null===(o=this.previousRemediator)||void 0===o?void 0:o.getName(),a=t.getName();return ("select-authenticator-authenticate"!==a||!["select-authenticator-authenticate","reenroll-authenticator"].includes(i))&&(("select-authenticator-authenticate"!==a||!e.some((function(t){return "challenge-authenticator"===t.name})))&&nr()(qn()(n.prototype),"isRemediatorCandidate",this).call(this,t,e,r))}},{key:"isFinished",value:function(){var t=this,e=Object.create(null,{isFinished:{get:function(){return nr()(qn()(n.prototype),"isFinished",t)}}});return Hr(this,void 0,void 0,f.a.mark((function t(){var n;return f.a.wrap((function(t){for(;;)switch(t.prev=t.next){case 0:return t.next=2,hn(this.authClient);case 2:if(n=t.sent,n.remediations.includes("reset-authenticator")){t.next=6;break}return t.abrupt("return",!1);case 6:return t.next=8,e.isFinished.call(this);case 8:return t.abrupt("return",t.sent);case 9:case"end":return t.stop()}}),t,this)})))}}]),n}(Ur),Kr=function(t,e,n,r){return new(n||(n=Promise))((function(o,i){function a(t){try{s(r.next(t));}catch(t){i(t);}}function u(t){try{s(r.throw(t));}catch(t){i(t);}}function s(t){var e;t.done?o(t.value):(e=t.value,e instanceof n?e:new n((function(t){t(e);}))).then(a,u);}s((r=r.apply(t,e||[])).next());}))},Vr={identify:or,"select-authenticator-authenticate":vr,"select-authenticator-enroll":gr,"authenticator-enrollment-data":Tr,"authenticator-verification-data":Or,"enroll-authenticator":Yn,"challenge-authenticator":Jn,"reenroll-authenticator":ar,"redirect-idp":sr};function zr(t,e){return Kr(this,void 0,void 0,f.a.mark((function n(){var r;return f.a.wrap((function(n){for(;;)switch(n.prev=n.next){case 0:return r=new Dr(t),n.abrupt("return",Ir(t,Object.assign(Object.assign({},e),{flow:Vr,flowMonitor:r})));case 2:case"end":return n.stop()}}),n)})))}var Yr=function(t,e,n,r){return new(n||(n=Promise))((function(o,i){function a(t){try{s(r.next(t));}catch(t){i(t);}}function u(t){try{s(r.throw(t));}catch(t){i(t);}}function s(t){var e;t.done?o(t.value):(e=t.value,e instanceof n?e:new n((function(t){t(e);}))).then(a,u);}s((r=r.apply(t,e||[])).next());}))};function Gr(t,e){return Yr(this,void 0,void 0,f.a.mark((function n(){return f.a.wrap((function(n){for(;;)switch(n.prev=n.next){case 0:return n.abrupt("return",Ir(t,Object.assign(Object.assign({},e),{actions:["cancel"]})));case 1:case"end":return n.stop()}}),n)})))}var Jr=function(t,e,n,r){return new(n||(n=Promise))((function(o,i){function a(t){try{s(r.next(t));}catch(t){i(t);}}function u(t){try{s(r.throw(t));}catch(t){i(t);}}function s(t){var e;t.done?o(t.value):(e=t.value,e instanceof n?e:new n((function(t){t(e);}))).then(a,u);}s((r=r.apply(t,e||[])).next());}))};function $r(t){var e=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{};return Jr(this,void 0,void 0,f.a.mark((function n(){return f.a.wrap((function(n){for(;;)switch(n.prev=n.next){case 0:return n.abrupt("return",Ir(t,e));case 1:case"end":return n.stop()}}),n)})))}var Wr=function(t,e,n,r){return new(n||(n=Promise))((function(o,i){function a(t){try{s(r.next(t));}catch(t){i(t);}}function u(t){try{s(r.throw(t));}catch(t){i(t);}}function s(t){var e;t.done?o(t.value):(e=t.value,e instanceof n?e:new n((function(t){t(e);}))).then(a,u);}s((r=r.apply(t,e||[])).next());}))},Xr={"select-enroll-profile":br,"enroll-profile":tr,"authenticator-enrollment-data":Tr,"select-authenticator-enroll":gr,"enroll-authenticator":Yn,skip:Er};function Zr(t,e){return Wr(this,void 0,void 0,f.a.mark((function n(){var r,o,i,a;return f.a.wrap((function(n){for(;;)switch(n.prev=n.next){case 0:if(ln(t)){n.next=8;break}return n.next=3,$r(t,e);case 3:if(r=n.sent,!(o=r.enabledFeatures)||o.includes(Vt.REGISTRATION)){n.next=8;break}return i=new it.c("Registration is not supported based on your current org configuration."),n.abrupt("return",{status:Kt.FAILURE,error:i});case 8:return a=new Fr(t),n.abrupt("return",Ir(t,Object.assign(Object.assign({},e),{flow:Xr,flowMonitor:a})));case 10:case"end":return n.stop()}}),n)})))}var Qr=function(t,e,n,r){return new(n||(n=Promise))((function(o,i){function a(t){try{s(r.next(t));}catch(t){i(t);}}function u(t){try{s(r.throw(t));}catch(t){i(t);}}function s(t){var e;t.done?o(t.value):(e=t.value,e instanceof n?e:new n((function(t){t(e);}))).then(a,u);}s((r=r.apply(t,e||[])).next());}))},to={identify:or,"identify-recovery":or,"select-authenticator-authenticate":vr,"challenge-authenticator":Jn,"authenticator-verification-data":Or,"reset-authenticator":Wn,"reenroll-authenticator":ar};function eo(t,e){return Qr(this,void 0,void 0,f.a.mark((function n(){var r;return f.a.wrap((function(n){for(;;)switch(n.prev=n.next){case 0:return r=new qr(t),n.abrupt("return",Ir(t,Object.assign(Object.assign({},e),{flow:to,flowMonitor:r,actions:["currentAuthenticator-recover","currentAuthenticatorEnrollment-recover"]})));case 2:case"end":return n.stop()}}),n)})))}var no=function(t,e,n,r){return new(n||(n=Promise))((function(o,i){function a(t){try{s(r.next(t));}catch(t){i(t);}}function u(t){try{s(r.throw(t));}catch(t){i(t);}}function s(t){var e;t.done?o(t.value):(e=t.value,e instanceof n?e:new n((function(t){t(e);}))).then(a,u);}s((r=r.apply(t,e||[])).next());}))};function ro(t,e){return no(this,void 0,void 0,f.a.mark((function n(){var r,o,i,a,u,s,c,l,h,p;return f.a.wrap((function(n){for(;;)switch(n.prev=n.next){case 0:if(r=t.transactionManager.load()){n.next=3;break}throw new it.c("No transaction data was found in storage");case 3:if(o=r.codeVerifier,i=r.state,a=new URL(e),u=a.searchParams,s=u.get("state"),c=u.get("interaction_code"),!(l=u.get("error"))){n.next=10;break}throw new it.d(l,u.get("error_description"));case 10:if(s===i){n.next=12;break}throw new it.c("State in redirect uri does not match with transaction state");case 12:if(c){n.next=14;break}throw new it.c("Unable to parse interaction_code from the url");case 14:return n.next=16,t.token.exchangeCodeForTokens({interactionCode:c,codeVerifier:o});case 16:h=n.sent,p=h.tokens,t.tokenManager.setTokens(p);case 19:case"end":return n.stop()}}),n)})))}var oo=n(211),io=function(t,e,n,r){return new(n||(n=Promise))((function(o,i){function a(t){try{s(r.next(t));}catch(t){i(t);}}function u(t){try{s(r.throw(t));}catch(t){i(t);}}function s(t){var e;t.done?o(t.value):(e=t.value,e instanceof n?e:new n((function(t){t(e);}))).then(a,u);}s((r=r.apply(t,e||[])).next());}))},ao=function(t,e){var n={};for(var r in t)Object.prototype.hasOwnProperty.call(t,r)&&e.indexOf(r)<0&&(n[r]=t[r]);if(null!=t&&"function"==typeof Object.getOwnPropertySymbols){var o=0;for(r=Object.getOwnPropertySymbols(t);o<r.length;o++)e.indexOf(r[o])<0&&Object.prototype.propertyIsEnumerable.call(t,r[o])&&(n[r[o]]=t[r[o]]);}return n},uo=n(413),so=function(){function t(e){var n=this;a()(this,t),this.options=function(){var t=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{};return Ae(t),t=un(an(),t),Object(C.t)({issuer:Object(C.u)(t.issuer),tokenUrl:Object(C.u)(t.tokenUrl),authorizeUrl:Object(C.u)(t.authorizeUrl),userinfoUrl:Object(C.u)(t.userinfoUrl),revokeUrl:Object(C.u)(t.revokeUrl),logoutUrl:Object(C.u)(t.logoutUrl),clientId:t.clientId,redirectUri:t.redirectUri,state:t.state,scopes:t.scopes,postLogoutRedirectUri:t.postLogoutRedirectUri,responseMode:t.responseMode,responseType:t.responseType,pkce:!1!==t.pkce,useInteractionCodeFlow:t.useInteractionCodeFlow,httpRequestClient:t.httpRequestClient,transformErrorXHR:t.transformErrorXHR,transformAuthState:t.transformAuthState,restoreOriginalUri:t.restoreOriginalUri,storageUtil:t.storageUtil,headers:t.headers,devMode:!!t.devMode,storageManager:t.storageManager,cookies:Object(dt.isBrowser)()?on(t,Object(dt.isHTTPS)()):t.cookies,ignoreSignature:!!t.ignoreSignature,clientSecret:t.clientSecret})}(e);var r=this.options,o=r.storageManager,i=r.cookies,u=r.storageUtil;this.storageManager=new $e(o,i,u),this.transactionManager=new Xe(Object.assign({storageManager:this.storageManager},e.transactionManager)),this._oktaUserAgent=new oo.a,this.tx={status:z.bind(null,this),resume:Y.bind(null,this),exists:Object.assign(J.bind(null,this),{_get:function(t){return u.storage.get(t)}}),introspect:G.bind(null,this)},this.pkce={DEFAULT_CODE_CHALLENGE_METHOD:Q.DEFAULT_CODE_CHALLENGE_METHOD,generateVerifier:Q.generateVerifier,computeChallenge:Q.computeChallenge},Object.assign(this.options.storageUtil,{getPKCEStorage:this.storageManager.getLegacyPKCEStorage.bind(this.storageManager),getHttpCache:this.storageManager.getHttpCache.bind(this.storageManager)}),this._pending={handleLogin:!1},Object(dt.isBrowser)()?(this.options=Object.assign(this.options,{redirectUri:Object(C.v)(e.redirectUri,window.location.origin)}),this.userAgent=Re(e,"okta-auth-js/".concat("5.4.2"))):this.userAgent=Re(e,"okta-auth-js-server/".concat("5.4.2")),e.maxClockSkew||0===e.maxClockSkew?this.options.maxClockSkew=e.maxClockSkew:this.options.maxClockSkew=p,this.session={close:nt.bind(null,this),exists:tt.bind(null,this),get:et.bind(null,this),refresh:rt.bind(null,this),setCookieAndRedirect:ot.bind(null,this)},this._tokenQueue=new Be,this.token={prepareTokenParams:Nt.bind(null,this),exchangeCodeForTokens:ae.bind(null,this),getWithoutPrompt:le.bind(null,this),getWithPopup:ke.bind(null,this),getWithRedirect:Oe.bind(null,this),parseFromUrl:Se.bind(null,this),decode:oe,revoke:ie.bind(null,this),renew:ge.bind(null,this),renewTokensWithRefresh:pe.bind(null,this),renewTokens:be.bind(null,this),getUserInfo:xe.bind(null,this),verify:se.bind(null,this),isLoginRedirect:Lt.bind(null,this)};var s,c,f=["decode","isLoginRedirect"];Object.keys(this.token).forEach((function(t){if(!(f.indexOf(t)>=0)){var e=n.token[t];n.token[t]=Be.prototype.push.bind(n._tokenQueue,e,null);}})),Object.assign(this.token.getWithRedirect,{_setLocation:function(t){window.location=t;}}),Object.assign(this.token.parseFromUrl,{_getHistory:function(){return window.history},_getLocation:function(){return window.location},_getDocument:function(){return window.document}}),this.idx={interact:gn.bind(null,this),introspect:bn.bind(null,this),authenticate:zr.bind(null,this),register:Zr.bind(null,this),cancel:Gr.bind(null,this),recoverPassword:eo.bind(null,this),handleInteractionCodeRedirect:ro.bind(null,this),startTransaction:$r.bind(null,this)},c=this,s=function(t){var e=c._oktaUserAgent.getHttpHeader(),n=Object.assign(Object.assign({},e),c.options.headers);Object.keys(n).forEach((function(e){t.headers[e]=n[e];}));},cn.a.client.interceptors.request.use(s),this.http={setRequestHeader:P.bind(null,this)},this.fingerprint=He.bind(null,this),this.emitter=new uo,this.tokenManager=new De(this,e.tokenManager),this.authStateManager=new Ye(this);}return s()(t,[{key:"start",value:function(){this.tokenManager.start(),this.token.isLoginRedirect()||this.authStateManager.updateAuthState();}},{key:"stop",value:function(){this.tokenManager.stop();}},{key:"isInteractionRequired",value:function(){return Ft(this)}},{key:"isInteractionRequiredError",value:function(t){return Et(t)}},{key:"signIn",value:function(t){return io(this,void 0,void 0,f.a.mark((function e(){return f.a.wrap((function(e){for(;;)switch(e.prev=e.next){case 0:return e.abrupt("return",this.signInWithCredentials(t));case 1:case"end":return e.stop()}}),e,this)})))}},{key:"signInWithCredentials",value:function(t){return io(this,void 0,void 0,f.a.mark((function e(){var n,r=this;return f.a.wrap((function(e){for(;;)switch(e.prev=e.next){case 0:if(t=Object(C.b)(t||{}),n=function(e){return (e=e||{}).withCredentials=!0,delete t.sendFingerprint,$(r,"/api/v1/authn",t,e)},t.sendFingerprint){e.next=4;break}return e.abrupt("return",n());case 4:return e.abrupt("return",this.fingerprint().then((function(t){return n({headers:{"X-Device-Fingerprint":t}})})));case 5:case"end":return e.stop()}}),e,this)})))}},{key:"signInWithRedirect",value:function(){var t=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{};return io(this,void 0,void 0,f.a.mark((function e(){var n,r,o;return f.a.wrap((function(e){for(;;)switch(e.prev=e.next){case 0:if(n=t.originalUri,r=ao(t,["originalUri"]),!this._pending.handleLogin){e.next=3;break}return e.abrupt("return");case 3:return this._pending.handleLogin=!0,e.prev=4,n&&this.setOriginalUri(n),o=Object.assign({scopes:this.options.scopes||["openid","email","profile"]},r),e.next=9,this.token.getWithRedirect(o);case 9:return e.prev=9,this._pending.handleLogin=!1,e.finish(9);case 12:case"end":return e.stop()}}),e,this,[[4,,9,12]])})))}},{key:"closeSession",value:function(){return this.tokenManager.clear(),this.session.close().catch((function(t){if("AuthApiError"===t.name&&"E0000007"===t.errorCode)return null;throw t}))}},{key:"revokeAccessToken",value:function(t){return io(this,void 0,void 0,f.a.mark((function e(){var n;return f.a.wrap((function(e){for(;;)switch(e.prev=e.next){case 0:if(t){e.next=6;break}return e.next=3,this.tokenManager.getTokens();case 3:t=e.sent.accessToken,n=this.tokenManager.getStorageKeyByType("accessToken"),this.tokenManager.remove(n);case 6:if(t){e.next=8;break}return e.abrupt("return",Promise.resolve(null));case 8:return e.abrupt("return",this.token.revoke(t));case 9:case"end":return e.stop()}}),e,this)})))}},{key:"revokeRefreshToken",value:function(t){return io(this,void 0,void 0,f.a.mark((function e(){var n;return f.a.wrap((function(e){for(;;)switch(e.prev=e.next){case 0:if(t){e.next=6;break}return e.next=3,this.tokenManager.getTokens();case 3:t=e.sent.refreshToken,n=this.tokenManager.getStorageKeyByType("refreshToken"),this.tokenManager.remove(n);case 6:if(t){e.next=8;break}return e.abrupt("return",Promise.resolve(null));case 8:return e.abrupt("return",this.token.revoke(t));case 9:case"end":return e.stop()}}),e,this)})))}},{key:"getSignOutRedirectUrl",value:function(){var t=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{},e=t.idToken,n=t.postLogoutRedirectUri,r=t.state;if(e||(e=this.tokenManager.getTokensSync().idToken),!e)return "";n||(n=this.options.postLogoutRedirectUri);var o=Tt(this).logoutUrl,i=e.idToken,a=o+"?id_token_hint="+encodeURIComponent(i);return n&&(a+="&post_logout_redirect_uri="+encodeURIComponent(n)),r&&(a+="&state="+encodeURIComponent(r)),a}},{key:"signOut",value:function(t){return io(this,void 0,void 0,f.a.mark((function e(){var n,r,o,i,a,u,s,c;return f.a.wrap((function(e){for(;;)switch(e.prev=e.next){case 0:if(t=Object.assign({},t),n=window.location.origin,r=window.location.href,o=t.postLogoutRedirectUri||this.options.postLogoutRedirectUri||n,i=t.accessToken,a=t.refreshToken,u=!1!==t.revokeAccessToken,(s=!1!==t.revokeRefreshToken)&&void 0===a&&(a=this.tokenManager.getTokensSync().refreshToken),u&&void 0===i&&(i=this.tokenManager.getTokensSync().accessToken),t.idToken||(t.idToken=this.tokenManager.getTokensSync().idToken),this.tokenManager.clear(),!s||!a){e.next=15;break}return e.next=15,this.revokeRefreshToken(a);case 15:if(!u||!i){e.next=18;break}return e.next=18,this.revokeAccessToken(i);case 18:if(c=this.getSignOutRedirectUrl(Object.assign(Object.assign({},t),{postLogoutRedirectUri:o}))){e.next=23;break}return e.abrupt("return",this.closeSession().then((function(){o===r?window.location.reload():window.location.assign(o);})));case 23:window.location.assign(c);case 24:case"end":return e.stop()}}),e,this)})))}},{key:"webfinger",value:function(t){return U(this,"/.well-known/webfinger"+Object(C.w)(t),{headers:{Accept:"application/jrd+json"}})}},{key:"isAuthenticated",value:function(){return io(this,void 0,void 0,f.a.mark((function t(){var e,n,r,o,i,a;return f.a.wrap((function(t){for(;;)switch(t.prev=t.next){case 0:if(e=this.tokenManager.getTokensSync(),n=e.accessToken,r=e.idToken,o=this.options.tokenManager||{},i=o.autoRenew,a=o.autoRemove,!n||!this.tokenManager.hasExpired(n)){t.next=11;break}if(n=null,!i){t.next=10;break}return t.next=7,this.tokenManager.renew("accessToken");case 7:n=t.sent,t.next=11;break;case 10:a&&this.tokenManager.remove("accessToken");case 11:if(!r||!this.tokenManager.hasExpired(r)){t.next=20;break}if(r=null,!i){t.next=19;break}return t.next=16,this.tokenManager.renew("idToken");case 16:r=t.sent,t.next=20;break;case 19:a&&this.tokenManager.remove("idToken");case 20:return t.abrupt("return",!(!n||!r));case 21:case"end":return t.stop()}}),t,this)})))}},{key:"getUser",value:function(){return io(this,void 0,void 0,f.a.mark((function t(){var e,n,r;return f.a.wrap((function(t){for(;;)switch(t.prev=t.next){case 0:return e=this.tokenManager.getTokensSync(),n=e.idToken,r=e.accessToken,t.abrupt("return",this.token.getUserInfo(r,n));case 2:case"end":return t.stop()}}),t,this)})))}},{key:"getIdToken",value:function(){var t=this.tokenManager.getTokensSync().idToken;return t?t.idToken:void 0}},{key:"getAccessToken",value:function(){var t=this.tokenManager.getTokensSync().accessToken;return t?t.accessToken:void 0}},{key:"getRefreshToken",value:function(){var t=this.tokenManager.getTokensSync().refreshToken;return t?t.refreshToken:void 0}},{key:"storeTokensFromRedirect",value:function(){return io(this,void 0,void 0,f.a.mark((function t(){var e,n;return f.a.wrap((function(t){for(;;)switch(t.prev=t.next){case 0:return t.next=2,this.token.parseFromUrl();case 2:e=t.sent,n=e.tokens,this.tokenManager.setTokens(n);case 5:case"end":return t.stop()}}),t,this)})))}},{key:"setOriginalUri",value:function(t){Ee.getSessionStorage().setItem(_,t);}},{key:"getOriginalUri",value:function(){return Ee.getSessionStorage().getItem(_)}},{key:"removeOriginalUri",value:function(){Ee.getSessionStorage().removeItem(_);}},{key:"isLoginRedirect",value:function(){return Lt(this)}},{key:"handleLoginRedirect",value:function(t){return io(this,void 0,void 0,f.a.mark((function e(){var n,r;return f.a.wrap((function(e){for(;;)switch(e.prev=e.next){case 0:if(!t){e.next=4;break}this.tokenManager.setTokens(t),e.next=10;break;case 4:if(!this.isLoginRedirect()){e.next=9;break}return e.next=7,this.storeTokensFromRedirect();case 7:e.next=10;break;case 9:return e.abrupt("return");case 10:return e.next=12,this.authStateManager.updateAuthState();case 12:if(n=this.getOriginalUri(),this.removeOriginalUri(),!(r=this.options.restoreOriginalUri)){e.next=20;break}return e.next=18,r(this,n);case 18:e.next=21;break;case 20:window.location.replace(n);case 21:case"end":return e.stop()}}),e,this)})))}},{key:"isPKCE",value:function(){return !!this.options.pkce}},{key:"hasResponseType",value:function(t){var e=!1;return e=Array.isArray(this.options.responseType)&&this.options.responseType.length?this.options.responseType.indexOf(t)>=0:this.options.responseType===t,e}},{key:"isAuthorizationCodeFlow",value:function(){return this.hasResponseType("code")}},{key:"getIssuerOrigin",value:function(){return this.options.issuer.split("/oauth2/")[0]}},{key:"forgotPassword",value:function(t){return $(this,"/api/v1/authn/recovery/password",t)}},{key:"unlockAccount",value:function(t){return $(this,"/api/v1/authn/recovery/unlock",t)}},{key:"verifyRecoveryToken",value:function(t){return $(this,"/api/v1/authn/recovery/token",t)}}]),t}();so.features=so.prototype.features=dt,Object.assign(so,{constants:r,isInteractionRequiredError:Et});var co=so;}])}));
    ...
    var oktaAuthJs_umd_4 = oktaAuthJs_umd.AuthSdkError;
    var oktaAuthJs_umd_5 = oktaAuthJs_umd.OktaAuth;
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 2:
                            ...
                            if (this.oktaAuth.isInteractionRequiredError(e_1) && this.injector) {
    ...
    var OktaAuthStateService = /** @class */ (function () {
        ...
        OktaAuthStateService.decorators = [
            { type: core.Injectable }
        ];
        OktaAuthStateService.ctorParameters = function () { return [
            { type: oktaAuthJs_umd_5 }
        ]; };
    ...
    var OktaHasAnyGroupDirective = /** @class */ (function () {
        ...
        OktaHasAnyGroupDirective.decorators = [
            { type: core.Directive, args: [{ selector: '[oktaHasAnyGroup]' },] }
        ];
        ...
        OktaHasAnyGroupDirective.propDecorators = {
            oktaHasAnyGroup: [{ type: core.Input }]
        };
    ...
    var OktaAuthModule = /** @class */ (function () {
        function OktaAuthModule(config, location, router) {
            ...
            if (!oktaAuth._oktaUserAgent) {
                throw new oktaAuthJs_umd_4('_oktaUserAgent is not available on auth SDK instance. Please use okta-auth-js@^5.3.1 or higher.');
            }
            ...
            if (packageInfo.authJSMajorVersion !== majorVersion) {
                throw new oktaAuthJs_umd_4("Passed in oktaAuth is not compatible with the SDK, okta-auth-js version " + packageInfo.authJSMajorVersion + ".x is the current supported version.");
            }
            // Add Okta UA
    ...
    exports.ɵa = OktaHasAnyGroupDirective;
