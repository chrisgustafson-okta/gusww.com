...
import { InjectionToken, Component, Inject, Injector, Optional, Injectable, Directive, TemplateRef, ViewContainerRef, Input, NgModule } from '@angular/core';
...
OktaAuthStateService.ctorParameters = () => [
    { type: OktaAuth }
];
...
OktaHasAnyGroupDirective.ctorParameters = () => [
    { type: TemplateRef },
...
class OktaAuthModule {
    constructor(config, location, router) {
        ...
        const majorVersion = +(oktaAuthVersion === null || oktaAuthVersion === void 0 ? void 0 : oktaAuthVersion.split('.')[0]);
...
OktaAuthModule.ctorParameters = () => [
    { type: undefined, decorators: [{ type: Inject, args: [OKTA_CONFIG,] }] },
    { type: Location, decorators: [{ type: Optional }] },
    { type: Router, decorators: [{ type: Optional }] }
];

export { OKTA_CONFIG, OktaAuthGuard, OktaAuthModule, OktaAuthStateService, OktaCallbackComponent, OktaHasAnyGroupDirective as ɵa };
